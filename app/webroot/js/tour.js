  ...
  steps: [
     ...
     // arrowOffset: 70
      ...
      //arrowOffset: 70			
		...
		{
      target: 'select2-proj_currency-container',
      title: _('Define Project Currency'),
      content: _('Define Project Currency to track your project'),
      placement: 'right', //top
			yOffset: 16,
			width: 240,
      //arrowOffset: 70,
      ...
      //multipage : true,
          ...
          $("#tour_sts_work_flow_setting")[0].scrollIntoView();
				},100);
			}
    },
		{
...
var onbd_tour_mngwork = {
  ...
  steps: [
      ...
      delay: 2000,
		...
		{
			target: 'filterModal', /*dropdown_menu_all_filters_t*/
