...
function fileGetCallback(fileName, file) {
    if (file.id != undefined) {
        ...
        var str = "<div id='gd_" + caseId + file.id + "'><div style='float:left;margin-top:2px;'><input id='chkbx_" + caseId + file.id + "' type='checkbox' checked='checked' onclick='removeLink(\"" + file.id + "\",\"" + file.title + "\");' style='cursor: pointer;' /></div><div style='float:left;margin-left: 6px;margin-top:4px; font-size: 14px;'><a href='" + file.alternateLink + "' target='_blank' title='" + file.title + "'>" + shortTitle + "</a><input type='hidden' name='data[Easycase][cloud_storage_files][]' value='" + content + "' /></div><div style='clear:both;'></div></div>";
