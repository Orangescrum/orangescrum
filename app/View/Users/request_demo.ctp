...
@media (min-width:300px) and (max-width:440px){
    ...
    /*blue tooltip ends*/
    /*Tipsy End*/
	.reply_task_block_info{position:absolute;width:187px;padding:10px; left:510px; top:375px; background:rgb(40, 175, 81);text-align:left;z-index:999;font-family:"MyriadPro-Regular";color:#fff;font-size:14px;}
</style>
<script>
function loader() {
            ...
            <div class="login_table">
                <div id="container" style="vertical-align:middle;">
                    ...
                    <div class="reply_task_block_info">
                        <p style="margin:0px;"><img src="../img/idea-ico.png" alt="" style="margin-right:5px;"/>Our Demo time is in between 8 am to 3 pm GMT. Please provide couple of your suitable time slots, so that we can schedule a Demo. </p>
                    </div>
                    <div class="gap10"></div>
