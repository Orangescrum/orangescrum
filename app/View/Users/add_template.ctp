							...
							<td valign="top">
								...
								<table cellpadding="6" cellspacing="6" align="center" border="5" width="100%"  >
									...
									<tr height="40px">
										...
										<td align="left">
										<span id="subprof1">
										<button type="submit" value="Update" name="submit_template" id="submit_template" class="pop_btn" onclick="document.getElementById('update_temp').value='1'"><?php if($tid == ''){echo __("Save");}else{echo __("Update");}?></button>
