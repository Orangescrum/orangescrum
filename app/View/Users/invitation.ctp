            ...
            <!--<td style="vertical-align:middle; height:100%">-->
                <div id="container" style="display:table-cell; vertical-align:middle">
                    <!--<tr>
					  ...
					  <label class="lbl_ie">First Name</label>
                        <?php echo $this->Form->text('name',array('size'=>'45','maxlength'=>'100','autocomplete'=>'off','placeholder'=>'First Name', 'id'=>'name', 'style'=>'background:#fff')); ?>                       
					  <input type="hidden" value="<?php echo $email;?>" name="invited_email" id="invited_email"/>
                     <div class="gap10"></div>                       
                           
                            <div style="margin-top:5px">
							
							 <!--<h2 style="font-weight:normal;color:#8a8a8a;font-weight:bold" class="sign_lable"><b>Last Name:</b></h2>-->
    
                       <!--<?php echo $this->Form->text('last_name',array('size'=>'45','id'=>'last_name','maxlength'=>'100','autocomplete'=>'off')); ?>-->
