						...
						<table width="100%" border="5" cellspacing="2" cellpadding="2" align="center">
										...
										<table cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td align="left">
													...
													<?php echo __('You are currently using');?> <font style="color:#EB592A;">
													<b>
													 <?php 
														echo "Orangescrum ".$GLOBALS['plan_types'][$user_subscription['subscription_id']]." &nbsp;&nbsp;&nbsp;";
														if($user_subscription['subscription_id']<4){
															echo "<a href='".HTTP_ROOT."pricing'>".__('Upgrade Now')."!</a>&nbsp;&nbsp;&nbsp;";
														}
														if($user_subscription['subscription_id']>2){
															echo "&nbsp;&nbsp;&nbsp;<a href='".HTTP_ROOT."pricing'>".__('Downgrade Now')."!</a>";
														}?>
													</b></font>
													<br/>
													<b>Account Status:</b>
													...
													echo $totMlst;
													?></font></strong> <font style="font-weight:normal;">Task Group(s)</font>
													<?php
							...
							<tr>
								<td valign="top">
									...
									<a class="btn btn-default btn_hover_link" href="<?php echo HTTP_ROOT; ?>dashboard">Cancel</a>
									</span>
									<span id="subprof2" style="display:none">
									<?php echo __('Updating');?>... <img src="<?php echo HTTP_IMAGES;?>images/del.gif" alt="Loading..." width="16" height="16"/>
									</span>
									</td>
									</tr>
									</table>
...
function checkImage(img_id)
{
	...
	{
		alert("<?php echo __('Invalid input file format! Should be an image file');?>.");
