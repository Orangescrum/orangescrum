...
<div class="all_report_dtlpage">
    <h2><?php echo __('Recent Created Tasks Report');?></h2>
	...
	<p class="small_report_txt"><?php echo __('This chart shows the tasks created in the last');?> <span class="dyn_filter_rpt" style="font-weight:bold;">7</span> <?php echo __('days');?>.</p>
    ...
    <div class="report_tbl">
        <table>
            <thead>
                <tr>
                    <th></th>
                    <th><?php echo __('Created Tasks (Unresolved)');?> <br /><span style="font-size:12px;">(<?php echo __('New & In-Progress');?>)</span></th>
                    <th><?php echo __('Created Tasks (Resolved)');?> <br /><span style="font-size:12px;">(<?php echo __('Resolved & Closed');?>)</span></th>
                </tr>
            </thead>
