<table width="100%" border="5" cellspacing="2" cellpadding="2" align="center" >
	<tr>
		<td align="left">
			<h1 class="toplink"><?php echo __('Project');?> > <?php echo __('Set Preference For Case');?></h1>
		</td>
	</tr>
	<tr>
		<td align="center">
				...
				<tr height="40px">
					...
					<td>
						<span id="loader_id1" style="display:none;">
							<img src="<?php echo HTTP_IMAGES;?>images/del.gif" width="16" height="16" alt="loading..." title="<?php echo __('loading');?>..."/>
						</span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="2">
						<div id="but" align="left" style="display:none;"  class="blue small">
							<span id="savspn">
								<button type="button" value="Post" name="data" style="margin-left:3px;margin:5px 0px;" class="" onclick="postcasedata('loader_id','but');"><?php echo __('Save');?></button>&nbsp;&nbsp;or&nbsp;&nbsp;<a href="<?php echo HTTP_ROOT; ?>dashboard"><?php echo __('Cancel');?></a>
							</span>
