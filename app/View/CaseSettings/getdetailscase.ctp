...
<tr height="40px">
<input type="hidden" id="project_uniqid" value="<?php echo $res['0']['projects']['uniq_id'];?>">
<td align="right" width="35%" style="padding-right:25px;" class="case_fieldprof"><?php echo __('Due Date');?>: </td>
<td>
...
<?php echo __('Today');?><span class="value"><?php echo __('today');?></span>	
<?php
}else if($csset['CaseSetting']['due_date'] == 'nextmonday'){ ?>

<?php echo __('Next Monday');?><span class="value"><?php echo __('nextmonday');?></span>
<?php 
}else if($csset['CaseSetting']['due_date'] == 'thisfriday'){ ?>
<?php echo __('This Friday');?><span class="value"><?php echo __('thisfriday');?></span>
<?php 
}else if($csset['CaseSetting']['due_date'] == 'tomorrow'){ ?>
<?php echo __('Tomorrow');?><span class="value"><?php echo __('tomorrow');?></span>
<?php  
}else{ ?>
<?php echo __('No Due Date');?><span class="value"><?php echo __('No Due Date');?></span>
<?php  } ?> 
</span></a>
</div>
...
<ul>
<li><a href="javascript:jsVoid()"><?php echo __('Today');?><span class="value"><?php echo __('today');?></span></a></li> 	
<li><a href="javascript:jsVoid()"><?php echo __('Next Monday');?><span class="value"><?php echo __('nextmonday');?></span></a></li> 
<li><a href="javascript:jsVoid()"><?php echo __('Tomorrow');?><span class="value"><?php echo __('tomorrow');?></span></a></li>
<li><a href="javascript:jsVoid()"><?php echo __('This Friday');?><span class="value"><?php echo __('thisfriday');?></span></a></li> 
...
<tr height="40px">
<td class="case_fieldprof" align="right" width="35%" style="padding-right:25px" class="case_fieldprof"><?php echo __('Priority');?>:
</td>
<td>
<span id="hd2">
...
<font style='color:#AD9227;font-size:13px;'><?php echo __('Low');?></font>
<span class="value"><?php echo __('LOW');?></span>

<?php
}else if($csset['CaseSetting']['priority'] == '1'){ ?>

<font style='color:#28AF51;font-size:13px;'><?php echo __('MEDIUM');?></font><span class="value"><?php echo __('medium');?></span> 
<?php 
}else if($csset['CaseSetting']['priority'] == '0'){ ?>
<font style='color:#AE432E;font-size:13px;'><?php echo __('HIGH');?></font><span class="value"><?php echo __('high');?></span> 
<?php  
}else { ?>
<span ><font style='color:#28AF51;font-size:13px;'>&nbsp;<?php echo __('MEDIUM');?></font></span>
...
<li>
<a href="javascript:jsVoid()"><font style='color:#AD9227;font-size:13px;'>&nbsp;<?php echo __('LOW');?></font>
<span class="value">2</span>
</a>
</li>
<li>
<a href="javascript:jsVoid()"><font style='color:#28AF51;font-size:13px;'>&nbsp;<?php echo __('MEDIUM');?></font>
<span class="value">1</span>
</a>
</li>
<li>
<a href="javascript:jsVoid()"><font style='color:#AE432E;font-size:13px;'>&nbsp;<?php echo __('HIGH');?></font>
...
<?php echo __('Email Notification');?>:&nbsp;<input id="hh" type="checkbox" checked=checked onclick="checkallusr('chkcnt')" value="all" style="cursor:pointer;"> 
</td>
<td>
<table>
<tr>
