...
<table border="0" style="border:1px solid #CFD7DD" width="100%" align="center" cellspacing="0" cellpadding="0">
	<tr bgcolor="#E5E5E5" valign="top" style="font-weight:bold;color:#333333;padding-left:5px;">
		...
		<td width="55px" align="right" style="padding-right:15px;"><?php echo __('Task');?>#</td>
		<td width="20px"></td>
		<td width="15px"></td>
		<td style="padding-left:10px;"><?php echo __('Title');?></td>
		<td width="80px"><?php echo __('Status');?></td>
		<td width="80px"><?php echo __('Due Date');?></td>
	</tr>
	<?php
	foreach($allCases as $getdata) { 
		...
		$frmtdata = html_entity_decode(trim($frmt_data));
		...
		<td style="font-weight:normal;<?php echo $class; ?>">
			...
			elseif($casePriority == 0){ 
				echo "<span class='tag red' style='width:5px;height:12px;' title='".__('High')."' rel='tooltip'>&nbsp;</span>";
			}
			elseif($casePriority == 1){ 
				echo "<span class='tag orange' style='width:5px;height:12px;' title='".__('Medium')."' rel='tooltip'>&nbsp;</span>";
			}
			elseif($casePriority >= 2){ 
				echo "<span class='tag green' style='width:5px;height:12px;' title='".__('Low')."' rel='tooltip'>&nbsp;</span>";
			}
			?>
		</td>
		<?php
...
<?php
	...
	?>
	<center style="font-weight:normal;color:#FF0000;padding:10px;"><?php echo __('No tasks available');?></center>
	<?php
}