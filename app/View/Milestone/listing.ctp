		...
		<div class="col-lg-4 proj_mng_div">
			<div class="col-lg-12 contain">
				...
				<div class="tsk_updts">
				    ...
				    ?>
				    <span id="tot_tasks<?php echo $milestone['Milestone']['id'];?>"><?php echo $total_cases;?></span> <?php echo __('Tasks');?>&nbsp; . &nbsp;<?php echo $milestone['0']['closed'];?> <?php echo __('Closed');?>
				</div>
				...
				<div class="proj_mng">
				    <div class="fl">
					<a href="javascript:void(0);" class="icon-add-task fl" onClick="addTaskToMilestone(this);" data-prj-id="<?php echo $milestone['Milestone']['project_id'];?>" data-id="<?php echo $milestone['Milestone']['id'];?>"><?php echo __('Move Task');?></a>
					<br />
					<?php if($type == 'completed') { ?>
					<a href="javascript:void(0);" class="icon-restore-mlstn fl" onClick="milestoneRestore(this);" data-uid="<?php echo $milestone['Milestone']['uniq_id'];?>" data-name="<?php echo $milestone['Milestone']['title'];?>"><?php echo __('Restore');?></a>
					<?php } else { ?>
					<a href="javascript:void(0);" class="icon-complete-mlstn fl" onClick="milestoneArchive(this);" data-uid="<?php echo $milestone['Milestone']['uniq_id'];?>" data-name="<?php echo $milestone['Milestone']['title'];?>"><?php echo __('Complete');?></a>
					<?php } ?>
				    </div>
				    <div class="fr">
					<a href="javascript:void(0);" class="icon-edit-mlstn fl" onClick="addEditMilestone(this);" data-id="<?php echo $milestone['Milestone']['id'];?>" data-uid="<?php echo $milestone['Milestone']['uniq_id'];?>" data-name="<?php echo $milestone['Milestone']['title'];?>"><?php echo __('Edit');?></a>
					<br />
					<a href="javascript:void(0);" class="icon-delete-mlstn fl" onClick="delMilestone(this);" data-uid="<?php echo $milestone['Milestone']['uniq_id'];?>" data-name="<?php echo $milestone['Milestone']['title'];?>"><?php echo __('Delete');?></a>
				    </div>
				</div>
			</div>
		</div>
	...
	<tr>
		...
		<?php $page = $casePage;
			if($page_limit < $caseCount){
				...
				if($data1){
				    if($type == 'completed'){
					echo "<li><a onclick='caseMilestone(".$projId.",\"".$projName."\",1);' href='javascript:void(0);' class=\"button_act\">&laquo; ".__('First')."</a></li>";
				   }else{
					echo "<li><a onclick='caseMilestone(".$projId.",\"".$projName."\",1);' href='javascript:void(0);' class=\"button_act\">&laquo; ".__('First')."</a></li>";
				   }
				...
				if($page != 1){
					$pageprev = $page-1;
				    if($type == 'completed'){
					 echo "<li><a onclick='caseMilestone(".$projId.",\"".$projName."\",".$pageprev.");' href='javascript:void(0);'  class=\"button_act\">&lt;&nbsp;".__('Prev')."</a></li>";
				    }else{
					 echo "<li><a  onclick='caseMilestone(".$projId.",\"".$projName."\",".$pageprev.");' href='javascript:void(0);'  class=\"button_act\">&lt;&nbsp;".__('Prev')."</a></li>";
				    }
				}else{
				...
				if(($caseCount - ($page_limit * $page)) > 0){
				    $pagenext = $page+1;
				    if($type == 'completed'){
						echo "<li><a onclick='caseMilestone(".$projId.",\"".$projName."\",".$pagenext.");' href='javascript:void(0);'  class=\"button_act\" >".__('Next')."&nbsp;&gt;</a></li>";
				    }else{
						echo "<li><a onclick='caseMilestone(".$projId.",\"".$projName."\",".$pagenext.");' href='javascript:void(0);'  class=\"button_act\" >".__('Next')."&nbsp;&gt;</a></li>";
				    }                                             
				}else{
				    if($type == 'completed'){
					 echo "<li><a onclick='caseMilestone(".$projId.",\"".$projName."\",".$pagenext.");' href='javascript:void(0);' class=\"button_prev\">".__('Next')."&nbsp;&gt;</a></li>";
				    }else{
					 echo "<li><a onclick='caseMilestone(".$projId.",\"".$projName."\",".$pagenext.");' href='javascript:void(0);'  class=\"button_prev\">".__('Next')."&nbsp;&gt;</a></li>";
				    }
				}
				if($data2){
				    echo "<li class='hellip'>&hellip;</li>";
				    if($type == 'completed'){
					 echo "<li><a onclick='caseMilestone(".$projId.",\"".$projName."\",".floor($lastPage).");' href='javascript:void(0);'  class=\"button_act\" >".__('Last')." &raquo;</a></li>";
				    }else{
					 echo "<li><a onclick='caseMilestone(".$projId.",\"".$projName."\",".floor($lastPage).");' href='javascript:void(0);'  class=\"button_act\" >".__('Last')." &raquo;</a></li>";
				    }
				}
