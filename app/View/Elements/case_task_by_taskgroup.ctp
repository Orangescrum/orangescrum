...
if(resCaseProj.length >0){ %>
	<% var sindex = 0;
            ...
            sindex++;
			   ...
			   %>
			   <?php /*
                if(projUniq == "all" && subTaskPname != getdata.Project.name ) { %>
               <tr class="list-dt-row">
                  <td colspan="8" align="left" class="curr_day tkt_pjname">
                     <div class="y_day mbtm10"><span><%= getdata.Project.name %></span></div>
                  </td>
               </tr>
               <tr class="separetor_tr"><td colspan="8"></td></tr>
               <% subTaskPname = getdata.Project.name } %>       
				*/?>
            ...
            <% } %>
			   ...
			   <td class="assi_tlist">
                  <div class="user-task-pf">
                    ...
                    <?php /* <% if(!getdata.AssignTo.photo){ %>
						 <% if((projUniq != "all") && showQuickActiononList){ %>
								 <span id="showUpdAssign<%= caseAutoId %>" <% if(isAllowed("Change Assigned to",projectUniqid)){ %> data-toggle="dropdown" <% } %>title="<%= usr_name_fst %>" class="clsptr cmn_profile_holder <%= getdata.AssignTo.usrPhotoBg %>" onclick="displayAssignToMem( <%= '\'' + caseAutoId + '\'' %> , <%= '\'' + projUniq + '\'' %> , <%= '\'' + caseAssgnUid + '\'' %> , <%= '\'' + caseUniqId + '\'' %> )"><%= usr_name_fst %></span>
							 <% } else { %>
								<span class="cmn_profile_holder <%= getdata.AssignTo.usrPhotoBg %>" id="showUpdAssign<%= caseAutoId %>" style="cursor:text;text-decoration:none;color:#a7a7a7;"><%= usr_name_fst %></span>
						<% } %>  
                     <% } else{ %>
						<%	if((projUniq != "all") && showQuickActiononList){ %>
						 <span id="showUpdAssign<%= caseAutoId %>" <% if(isAllowed("Change Assigned to",projectUniqid)){ %> data-toggle="dropdown" <% } %>title="<%= usr_name_fst %>"  onclick="displayAssignToMem( <%= '\'' + caseAutoId + '\'' %> , <%= '\'' + projUniq + '\'' %> , <%= '\'' + caseAssgnUid + '\'' %> , <%= '\'' + caseUniqId + '\'' %> )">
						 <img data-original="<?php echo HTTP_ROOT; ?>users/image_thumb/?type=photos&file=<%= getdata.AssignTo.photo %>&sizex=55&sizey=55&quality=100" class="lazy " width="55" height="55" title="<%= getdata.AssignTo.name %>"/>
						 </span>
						 <% } else { %>
               ...
               <td class="text-center"> 
                  <span id="csStsRep_sub<%= getdata.Easycase.id %>" class="">
					  ...
					  <% if(isAllowed("Create Task",projectUniqid)){ %>
                        ...
                        <% if((isAllowed("Edit Task",projectUniqid) && showQuickActiononListEdit2) || isAllowed("Edit All Task",projectUniqid)){ %> 
                         <li onclick="editask(<%= '\''+ caseUniqId1+'\',\''+projectUniqid+'\',\''+htmlspecialchars(projectName)+'\'' %>);" id="edit<%= caseAutoId1 %>" style=" <% if(showQuickActiononList1 || isAllowed('Edit All Task',projectUniqid) || (isAllowed('Edit Task',projectUniqid) && showQuickActiononListEdit1) ){ %>display:block <% } else { %>display:none<% } %>">
                          ...
                          <% } %>  
                          <% if(isAllowed("Change Other Details of Task",projectUniqid)){ %> 
                         <li onclick="copytask(<%= '\''+ caseUniqId1+'\',\''+ caseAutoId1+'\',\''+caseNo1+'\',\''+projId1+'\',\''+htmlspecialchars(projectName)+'\'' %>);" id="copy<%= caseAutoId1 %>" style=" <% if(showQuickActiononList1){ %>display:block <% } else { %>display:none<% } %>">
                          <a href="javascript:void(0);"><i class="material-icons">&#xE14D;</i><?php echo __('Copy');?></a>
                          </li> 
                          <% } %>
            ...
            <% } %>
              ...
              <td class="assi_tlist">
                  <div class="user-task-pf">
					 ...
					 <?php /*
                     <% if(!getdata1.AssignTo.photo){ %>
						 <% if((projUniq != "all") && showQuickActiononList1){ %>
								 <span id="showUpdAssign<%= caseAutoId1 %>" <% if(isAllowed("Change Assigned to",projectUniqid)){ %> data-toggle="dropdown" <% } %>title="<%= usr_name_fst %>" class="clsptr cmn_profile_holder <%= getdata1.AssignTo.usrPhotoBg %>" onclick="displayAssignToMem( <%= '\'' + caseAutoId1 + '\'' %> , <%= '\'' + projUniq + '\'' %> , <%= '\'' + caseAssgnUid1 + '\'' %> , <%= '\'' + caseUniqId1 + '\'' %> )"><%= usr_name_fst %></span>
							 <% } else { %>
								<span class="cmn_profile_holder <%= getdata1.AssignTo.usrPhotoBg %>" id="showUpdAssign<%= caseAutoId1 %>" style="cursor:text;text-decoration:none;color:#a7a7a7;"><%= usr_name_fst %></span>
						<% } %>  
                     <% } else{ %>
						<%	if((projUniq != "all") && showQuickActiononList1){ %>
						 <span id="showUpdAssign<%= caseAutoId1 %>" <% if(isAllowed("Change Assigned to",projectUniqid)){ %> data-toggle="dropdown" <% } %>title="<%= usr_name_fst %>"  onclick="displayAssignToMem( <%= '\'' + caseAutoId1 + '\'' %> , <%= '\'' + projUniq + '\'' %> , <%= '\'' + caseAssgnUid1 + '\'' %> , <%= '\'' + caseUniqId1 + '\'' %> )">
						 <img data-original="<?php echo HTTP_ROOT; ?>users/image_thumb/?type=photos&file=<%= getdata1.AssignTo.photo %>&sizex=55&sizey=55&quality=100" class="lazy " width="55" height="55" title="<%= getdata1.AssignTo.name %>"/>
						 </span>
						 <% } else { %>
							<span id="showUpdAssign<%= caseAutoId1 %>" style="cursor:text;text-decoration:none;color:#a7a7a7;">
							<img data-original="<?php echo HTTP_ROOT; ?>users/image_thumb/?type=photos&file=<%= getdata1.AssignTo.photo %>&sizex=55&sizey=55&quality=100" class="lazy " width="55" height="55" title="<%= getdata1.AssignTo.name %>"/>
							</span>
						<% } %>
					<% } %>
              ...
              <td class="esthrs_dt_tlist text-center">
                ...
                <td class="text-center"> 
                  <span id="csStsRep_sub<%= getdata1.Easycase.id %>" class="">
					  ...
					  <?php if($this->Format->isAllowed('Change Other Details of Task',$roleAccess)){ ?>
                        ...
                        <% if((isAllowed("Edit Task",projectUniqid) && showQuickActiononListEdit2) || isAllowed("Edit All Task",projectUniqid)){ %> 
                         <li onclick="editask(<%= '\''+ caseUniqId2+'\',\''+projectUniqid+'\',\''+htmlspecialchars(projectName)+'\'' %>);" id="edit<%= caseAutoId2 %>" style=" <% if(showQuickActiononList2 || isAllowed('Edit All Task',projectUniqid) || (isAllowed('Edit Task',projectUniqid) && showQuickActiononListEdit2) ){ %>display:block <% } else { %>display:none<% } %>">
                          ...
                          <% } %>  
                          <% if(isAllowed("Change Other Details of Task",projectUniqid)){ %> 
                         <li onclick="copytask(<%= '\''+ caseUniqId2+'\',\''+ caseAutoId2+'\',\''+caseNo2+'\',\''+projId2+'\',\''+htmlspecialchars(projectName)+'\'' %>);" id="copy<%= caseAutoId2 %>" style=" <% if(showQuickActiononList2){ %>display:block <% } else { %>display:none<% } %>">
                          <a href="javascript:void(0);"><i class="material-icons">&#xE14D;</i><?php echo __('Copy');?></a>
                          </li> 
                          <% } %>
            ...
            <% } %>
				...
				<td class="assi_tlist">
                  <div class="user-task-pf">
                     ...
                     <% var usr_name_fst = (getdata2.AssignTo.name != null)?getdata2.AssignTo.name:"<?php echo __("Unassigned");?>"; %>
						<?php /*
					<% if(!getdata2.AssignTo.photo){ %>
						 <% if((projUniq != "all") && showQuickActiononList2){ %>
								 <span id="showUpdAssign<%= caseAutoId2 %>" <% if(isAllowed("Change Assigned to",projectUniqid)){ %> data-toggle="dropdown" <% } %>title="<%= usr_name_fst %>" class="clsptr cmn_profile_holder <%= getdata2.AssignTo.usrPhotoBg %>" onclick="displayAssignToMem( <%= '\'' + caseAutoId2 + '\'' %> , <%= '\'' + projUniq + '\'' %> , <%= '\'' + caseAssgnUid2 + '\'' %> , <%= '\'' + caseUniqId2 + '\'' %> )"><%= usr_name_fst %></span>
							 <% } else { %>
								<span class="cmn_profile_holder <%= getdata2.AssignTo.usrPhotoBg %>" id="showUpdAssign<%= caseAutoId2 %>" style="cursor:text;text-decoration:none;color:#a7a7a7;"><%= usr_name_fst %></span>
						<% } %>  
                     <% } else{ %>
						<%	if((projUniq != "all") && showQuickActiononList2){ %>
						 <span id="showUpdAssign<%= caseAutoId2 %>" <% if(isAllowed("Change Assigned to",projectUniqid)){ %> data-toggle="dropdown" <% } %>title="<%= usr_name_fst %>"  onclick="displayAssignToMem( <%= '\'' + caseAutoId2 + '\'' %> , <%= '\'' + projUniq + '\'' %> , <%= '\'' + caseAssgnUid2 + '\'' %> , <%= '\'' + caseUniqId2 + '\'' %> )">
						 <img data-original="<?php echo HTTP_ROOT; ?>users/image_thumb/?type=photos&file=<%= getdata2.AssignTo.photo %>&sizex=55&sizey=55&quality=100" class="lazy " width="55" height="55" title="<%= getdata2.AssignTo.name %>"/>
						 </span>
						 <% } else { %>
							<span id="showUpdAssign<%= caseAutoId2 %>" style="cursor:text;text-decoration:none;color:#a7a7a7;">
							<img data-original="<?php echo HTTP_ROOT; ?>users/image_thumb/?type=photos&file=<%= getdata2.AssignTo.photo %>&sizex=55&sizey=55&quality=100" class="lazy " width="55" height="55" title="<%= getdata2.AssignTo.name %>"/>
							</span>
						<% } %>
					<% } %>
			   ...
			   <p class="<?php if($this->Format->isAllowed('Est Hours',$roleAccess)){ ?> estblists <?php } ?> estblist_subtask" <?php if($this->Format->isAllowed('Est Hours',$roleAccess)){ ?> style="cursor:pointer;" <?php } ?> id="est_blist_sub<%= getdata2.Easycase.id %>" case-id-val="<%= getdata2.Easycase.id %>">    
                ...
                <td class="text-center"> 
                  <span id="csStsRep_sub<%= getdata2.Easycase.id %>" class="">
