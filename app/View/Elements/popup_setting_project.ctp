<div class="modal-dialog">
    ...
    <div class="modal-content" style="min-height: 150px;">
        <div class="modal-header">
            ...
            <h4  class="ellipsis-view" style="max-width: 380px;" id="header_prj_setting">Estimation</h4>
        </div>       
        <div class="loader_dv" style="position:absolute;left:44%;top:47%;">
            <center><img src="<?php echo HTTP_IMAGES; ?>images/case_loader2.gif" alt="Loading..." title="Loading..." /></center>
        </div>
        <div id="inner_prj_setting" class="mils_ipad"></div>
    </div>
</div>