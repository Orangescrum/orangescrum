                ...
                <?php if ($data1) { ?>
                    <li>
                        <?php if (isset($pagemode) && $pagemode = 'ajax') { ?>
                            <a href="javascript:void(0)" onclick='<?php echo $callback; ?>(1<?php echo $extraarg; ?>);' class="button_act">&laquo; First</a>
                        <?php } else { ?>
...
<div class="os_pagination">
    ...
    if(page_limit < caseCount) {
        ...
        if(data1) { %>
                <li><a href="javascript:jsVoid();" class="button_act" onClick="inactiveCasePaging(1)">&laquo; <?php echo __('First');?></a></li>
    <% 	}
        if(page != 1) {
                var pageprev = page-1; %>
                <li class="button_act" onClick="inactiveCasePaging(<%= '\'' + pageprev + '\'' %>)">
                    <a href="javascript:void(0)"><i class="material-icons">&#xE314;</i><?php echo __('Prev');?></a>
                </li>
    <% 	} else { %>
                <li class="disabled button_prev">
                    <a href="javascript:void(0)"><i class="material-icons">&#xE314;</i><?php echo __('Prev');?></a>
    ...
    <% 		} else { %>
                        <li><a href="javascript:jsVoid();" class="button_act" onClick="inactiveCasePaging(<%= '\'' + i + '\'' %>)"><%= i %></a></li>
    <% 		}
        }
        if((caseCount - (page_limit * page)) > 0) {
                var pagenext = page+1; %>
                <li class="button_act" onClick="inactiveCasePaging(<%= '\'' + pagenext + '\'' %>)">
                    <a href="javascript:void(0)"><?php echo __('Next');?><i class="material-icons">&#xE315;</i></a>
                </li>
    <% 	} else { %>
                <li class="disabled button_prev">
    ...
    <% 	}
        if(data2) { %>
                <li><a href="javascript:jsVoid();" class="button_act" onClick="inactiveCasePaging(<%= '\'' + Math.floor(lastPage) + '\'' %>)"><?php echo __('Last');?> &raquo;</a></li>
    <% 	}
    } %>
    </ul>
</div>
