...
<div class="fixed-n-bar1" style="display:none">
	<div class="text-center">
		<?php echo __('Your account will be de-activated exactly on');?>
		<span style="font-weight:bold;"><?php echo $sun_error; ?></span> <?php echo __('due to failed payment');?>.&nbsp;<span
...
<div class="task-list-bar dbrd-bar">
	<div class="wrap_top_tlbar">
		<div class="row">
			<div class="col-lg-8">
				<h2><?php echo __('Simple & Flexible Pricing');?>
				</h2>
			</div>
			<?php if (SES_TYPE < 3) { ?>
			<?php $chk_accnt_sts = $this->Format->getAlertText($rem_users, $used_projects_count, $remspace, $used_storage); ?>
			...
			<div class="col-lg-12">
				<div class="<?php if($projtype !== 'active-grid') { ?> col-lg-6 col-sm-6  <?php  } else{ ?> col-lg-8 col-sm-8 <?php  } ?>">
					<ul id="tour_crt_proj_swtch" class="lft_tab_tasklist fl">
						<li
							class="all-list-glyph <?php if (($projtype == '' || $projtype == 'active-grid') && $filtype == '') { ?>active-list<?php } ?>">
							<a href="javascript:void(0)" class="all-list" onclick="setDefaultProjectView('<?php echo $act_grid_view_opt; ?>');
								$('#projectLoader').show();">
								<i class="material-icons">&#xE0DF;</i>
								<?php echo __('All');?>
								<span id="active_proj_cnt" class="counter">(<?php echo $active_project_cnt; ?>)</span>
							</a>
						</li>
						<li
							class="<?php if ($filtype == 'started') { ?>active-list<?php } ?>">
							<a href="<?php echo HTTP_ROOT; ?>projects/manage<?php echo $extr_proj_url_params; ?>?fil-type=started"
								onclick="$('#projectLoader').show(); resetProjectFilterItem();">
								<i class="material-icons">&#xE885;</i>
								<?php echo __('Started');?>
								<span id="started_proj_cnt" class="counter">(<?php echo isset($started_project_cnt) && $started_project_cnt > 0 ? $started_project_cnt : 0; ?>)</span>
							</a>
						</li>
						<li
							class="<?php if ($filtype == 'on-hold') { ?>active-list<?php } ?>">
							<a href="<?php echo HTTP_ROOT; ?>projects/manage<?php echo $extr_proj_url_params; ?>?fil-type=on-hold"
								onclick="$('#projectLoader').show();resetProjectFilterItem();">
								<i class="material-icons">&#xE052;</i>
								<?php echo __('On Hold');?>
								<span id="hold_proj_cnt" class="counter">(<?php echo isset($hold_project_cnt) && $hold_project_cnt > 0 ? $hold_project_cnt : 0; ?>)</span>
							</a>
						</li>
						<li
							class="<?php if ($filtype == 'stack') { ?>active-list<?php } ?>">
							<a href="<?php echo HTTP_ROOT; ?>projects/manage<?php echo $extr_proj_url_params; ?>?fil-type=stack"
								onclick="$('#projectLoader').show();resetProjectFilterItem();">
								<i class="material-icons">&#xE53B;</i>
								<?php echo __('Stack');?>
								<span id="stack_proj_cnt" class="counter">(<?php echo isset($stack_project_cnt) && $stack_project_cnt > 0 ? $stack_project_cnt : 0; ?>)</span>
							</a>
						</li>
						<?php if($this->Format->isAllowed('Complete Project',$roleAccess,0,SES_COMP)){ ?>
						<li
							class="<?php if (($projtype == 'inactive' || $projtype == 'inactive-grid') && $filtype == '') { ?>active-list<?php } ?>">
							<a href="javascript:void(0);" onclick="setDefaultProjectView('<?php echo $inact_grid_view_opt; ?>');
								$('#projectLoader').show();">
								<i class="material-icons">&#xE86C;</i>
								<?php echo __('Completed');?>
								<span id="inactive_proj_cnt" class="counter">(<?php echo $inactive_project_cnt; ?>)</span>
							</a>
						</li>
						<?php } ?>
					</ul>
				...
				<?php }  ?>
						<span id="task_impExp" class="dropdown task_expPrnt case-filter-menu">
							<a class="dropdown-toggle dropdown_menu_exp_print_togl pdf_export" style="top:3px;" data-toggle="dropdown"
								href="javascript:void(0);" data-target="#">
								<span class="export_file_icon"></span>
								<ul>
									<li style="text-align:left;" onclick="openProjectListExportPopup('excel');"><?php echo __('Export as Excel');?>
									</li>
									<li style="text-align:left;" onclick="openProjectListExportPopup('csv');"><?php echo __('Export as CSV');?>
									</li>
					...
					<ul class="lft_tab_tasklist fl wikitab" id="mlsttab">
						...
						<li id="mlstab_act_nonproj_wikis" class="invoice_lst_page_tabs">
							<a href="javascript:void(0)" onclick="switch_tab('nonprojectwikis')"
								id="completed_tab"><span class="wiki_icon nonprjwiki"></span> <?php echo __('Non Project Wikis');?></a>
						</li>
		...
		<div class="row">
			<div class="col-lg-10">
				<ul class="lft_tab_tasklist li_pad10">
					<li id="tour_actv_user"
						class="all-list-glyph <?php if ($role == '' || $role == 'all') { ?>active-list<?php } ?>">
...
<?php } elseif ((CONTROLLER == "reports"  || CONTROLLER == "Defects") && (PAGE_NAME == "glide_chart" || PAGE_NAME == "defect_report" || PAGE_NAME == "hours_report" || PAGE_NAME == "chart" || PAGE_NAME == "weeklyusage_report" || PAGE_NAME == "resource_utilization" || PAGE_NAME == "pending_task" || PAGE_NAME == "work_load" || PAGE_NAME == "timesheetReport" || PAGE_NAME == "profitable_report")) { ?>
<div class="task-list-bar  analytics-bar">
	<div class="wrap_top_tlbar">
		<div class="row">
			<div class="col-lg-12">
				<div class="col-lg-8 col-sm-8 pr_0">
					<ul class="lft_tab_tasklist fl">
						<?php if (SES_TYPE < 3 || $this->Format->isAllowed('View Hour Spent Report', $roleAccess)) { ?>
						<li
							class="all-list-glyph <?php if (CONTROLLER == "reports" && (PAGE_NAME == "hours_report")) { ?>active-list<?php } ?>">
							<a
								href="<?php echo HTTP_ROOT . "hours-report/" ?>">
                        ...
                        <li <?php if (CONTROLLER == "reports" && (PAGE_NAME == "chart")) { ?>class="active-list"
                            <?php } ?>>
                            <a
                                href="<?php echo HTTP_ROOT . "task-report/" ?>">
                                <i class="material-icons">&#xE862;</i>
						...
						<li
							class="<?php if (CONTROLLER == "reports" && (PAGE_NAME == "weeklyusage_report")) { ?>active-list<?php } ?>">
							<a
								href="<?php echo HTTP_ROOT . "reports/weeklyusage_report//" ?>">
								<i class="material-icons">&#xE922;</i>
				...
				<div class="col-lg-4 col-sm-4 weeklytime_report analytic_form_fld <?php
					...
					<div class="pfl-icon-dv-wl pfl-icon-dv res_utli fr">
						<span class="dropdown">
							...
							<ul
								class="dropdown-menu resource-utilization-filter drop_menu_mc dropdown_menu_all_filters_ul">
								<li class="drop_menu_mc">
									<a class="dropdown-toggle" data-toggle="dropdown" data-target="#"
										href="javascript:void(0)"
										onclick="util_fns.allfiltervalue('utilization', event);"><i
											class="material-icons">&#xE916;</i><?php echo __('Date');?></a>
									<ul class="dropdown_status dropdown-menu drop_smenu ltsm arch-due-dt"
										id="dropdown_menu_utilization">
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox" id="utilization_today"
														data-id="today" <?php
                                                            if ($_COOKIE['utilization_date_filter'] == 'today' || $_COOKIE['utilization_date_filter'] == 'all') {
                                                                echo "checked";
                                                            }
                                                        ?> onclick="util_fns.utilization('today',
													'check');"/> <?php echo __('Today');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox"
														id="utilization_yesterday" data-id="yesterday" <?php
										...
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox"
														id="utilization_thisweek" data-id="thisweek" <?php
										...
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox"
														id="utilization_thismonth" data-id="thismonth" <?php
										...
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox"
														id="utilization_thisquarter" data-id="thisquarter" <?php
										...
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox"
														id="utilization_thisyear" data-id="thisyear" <?php
										...
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox"
														id="utilization_lastweek" data-id="lastweek" <?php
										...
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox"
														id="utilization_lastmonth" data-id="lastmonth" <?php
										...
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox"
														id="utilization_lastquarter" data-id="lastquarter" <?php
										...
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox"
														id="utilization_lastyear" data-id="lastyear" <?php
										...
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox"
														id="utilization_last365days" data-id="last365days" <?php
										...
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox" data-id="custom"
														id="utilization_custom" <?php
										...
										<li class="custome_timelog custom_date_li" style="display: none;">
											...
											<div class="frto_sch">
												...
												<input type="text" class="smal_txt form-control "
													...
													value="<?php echo @$dt[1]; ?>" />
												<button
													class="btn btn-sm btn-raised  btn_cmn_efect cmn_bg btn-info cdate_btn aply_btn"
													type="button" onclick="util_fns.utilization('custom', 'Custom');"
								...
								<li class="drop_menu_mc">
									<a class="dropdown-toggle" data-toggle="dropdown" data-target="#"
										href="javascript:void(0)"
										onclick="util_fns.allfiltervalue('utilization_project', event);"><i
								...
								<?php if ($this->Format->isAllowed('View All Resource', $roleAccess)) { ?>
								<li class="drop_menu_mc dropdown">
									<a href="javascript:void(0)" class="dropdown-toggle" data-target="#"
										data-toggle="dropdown"
										onclick="util_fns.allfiltervalue('utilization_resource', event);"><i
											class="material-icons cmn-icon-prop">&#xE7FB;</i><?php echo __('Resource');?></a>
									<ul class="dropdown_status dropdown-menu drop_smenu ltsm scroll-listing"
					...
					<div class="fr pfl-icon-dv res_utli">
						<span class="dropdown">
							...
							<ul
								...
								<li class="drop_menu_mc">
									<a class="dropdown-toggle" data-toggle="dropdown" data-target="#"
										href="javascript:void(0)" onclick="allfiltervalue('utilization', event);"><i
											class="material-icons">&#xE916;</i><?php echo __('Date');?></a>
									<ul class="dropdown_status dropdown-menu drop_smenu ltsm arch-due-dt"
										id="dropdown_menu_utilization">
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls cst_date_cls_resrc" type="checkbox"
														id="utilization_today" data-id="today" <?php
                                                            if ($_COOKIE['utilization_date_filter'] == 'today') {
                                                                echo "checked";
                                                            }
                                                        ?> onclick="utilization('today',
													'check');"/> <?php echo __('Today');?>
												</label>
											</div>
										</li>
											...
											<div class="checkbox">
												<label>
													<input class="cst_date_cls cst_date_cls_resrc" type="checkbox"
                                                        ...
                                                        ?> onclick="utilization('yesterday',
													'check');"/> <?php echo __('Yesterday');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls cst_date_cls_resrc" type="checkbox"
                                                        ...
                                                        ?> onclick="utilization('thisweek',
													'check');"/> <?php echo __('This Week');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls cst_date_cls_resrc" type="checkbox"
                                                        ...
                                                        ?> onclick="utilization('thismonth',
													'check');"/> <?php echo __('This Month');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls cst_date_cls_resrc" type="checkbox"
                                                        ...
                                                        ?> onclick="utilization('thisquarter',
													'check');"/> <?php echo __('This Quarter');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls cst_date_cls_resrc" type="checkbox"
                                                        ...
                                                        ?> onclick="utilization('thisyear',
													'check');"/> <?php echo __('This Year');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls cst_date_cls_resrc" type="checkbox"
                                                        ...
                                                        ?> onclick="utilization('lastweek',
													'check');"/> <?php echo __('Last Week');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls cst_date_cls_resrc" type="checkbox"
                                                        ...
                                                        ?> onclick="utilization('lastmonth',
													'check');"/> <?php echo __('Last Month');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls cst_date_cls_resrc" type="checkbox"
                                                        ...
                                                        ?> onclick="utilization('lastquarter',
													'check');"/> <?php echo __('Last Quarter');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls cst_date_cls_resrc" type="checkbox"
                                                        ...
                                                        ?> onclick="utilization('lastyear',
													'check');"/> <?php echo __('Last Year');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls cst_date_cls_resrc" type="checkbox"
                                                        ...
                                                        ?> onclick="utilization('last365days',
													'check');"/> <?php echo __('Last 365 days');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
								...
								<li class="drop_menu_mc dropdown">
									<a href="javascript:void(0)" class="dropdown-toggle" data-target="#"
										data-toggle="dropdown" onclick="allfiltervalue('utilization_status', event);"><i
								...
								<li class="drop_menu_mc dropdown">
									<a href="javascript:void(0)" class="dropdown-toggle" data-target="#"
										data-toggle="dropdown" onclick="allfiltervalue('utilization_label', event);"><i
								...
								<li class="drop_menu_mc dropdown">
									...
									<ul class="dropdown_status dropdown-menu drop_smenu ltsm scroll-listing"
										...
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input type="checkbox" class="utilization-billability"
														id="utilization_billable" data-id="billable"
														onclick="utilization_billability('billable', 'check');" />
										...
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input type="checkbox" class="utilization-billability"
														id="utilization_unbillable" data-id="unbillable"
														onclick="utilization_billability('unbillable', 'check');" />
					...
					<?php } elseif (PAGE_NAME == 'pending_task') { ?>
					<div class="fr pfl-icon-dv pen_task">
						<span class="dropdown">
							...
							<ul class="dropdown-menu pending-task-filter drop_menu_mc dropdown_menu_all_filters_ul">
								<li class="drop_menu_mc">
									<a class="dropdown-toggle" data-toggle="dropdown" data-target="#"
										href="javascript:void(0)" onclick="allfiltervalue('pendingtask', event);"><i
											class="material-icons">&#xE916;</i><?php echo __('Date');?></a>
									<ul class="dropdown_status dropdown-menu drop_smenu ltsm arch-due-dt"
										id="dropdown_menu_pendingtask">
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox" id="pending_today"
														data-id="today" <?php
                                                            if ($_COOKIE['pending_date_filter'] == 'today') {
                                                                echo "checked";
                                                            }
                                                        ?> onclick="pendingtask('today',
													'check');"/> <?php echo __('Today');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox" id="pending_yesterday"
														data-id="yesterday" <?php
                                                            if ($_COOKIE['pending_date_filter'] == 'yesterday') {
                                                                echo "checked";
                                                            }
                                                        ?> onclick="pendingtask('yesterday',
													'check');"/> <?php echo __('Yesterday');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox" id="pending_thisweek"
														data-id="thisweek" <?php
                                                            if ($_COOKIE['pending_date_filter'] == 'thisweek') {
                                                                echo "checked";
                                                            }
                                                        ?> onclick="pendingtask('thisweek',
													'check');"/> <?php echo __('This Week');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox" id="pending_thismonth"
														data-id="thismonth" <?php
                                                            if ($_COOKIE['pending_date_filter'] == 'thismonth') {
                                                                echo "checked";
                                                            }
                                                        ?> onclick="pendingtask('thismonth',
													'check');"/> <?php echo __('This Month');?>
												</label>
											</div>
										</li>
											...
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox" id="pending_thisquarter"
                                                        ...
                                                        ?> onclick="pendingtask('thisquarter',
													'check');"/> <?php echo __('This Quarter');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox" id="pending_thisyear"
														data-id="thisyear" <?php
                                                            if ($_COOKIE['pending_date_filter'] == 'thisyear') {
                                                                echo "checked";
                                                            }
                                                        ?> onclick="pendingtask('thisyear',
													'check');"/> <?php echo __('This Year');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox" id="pending_lastweek"
														data-id="lastweek" <?php
                                                            if ($_COOKIE['pending_date_filter'] == 'lastweek') {
                                                                echo "checked";
                                                            }
                                                        ?> onclick="pendingtask('lastweek',
													'check');"/> <?php echo __('Last Week');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox" id="pending_lastmonth"
														data-id="lastmonth" <?php
                                                            if ($_COOKIE['pending_date_filter'] == 'lastmonth') {
                                                                echo "checked";
                                                            }
                                                        ?> onclick="pendingtask('lastmonth',
													'check');"/> <?php echo __('Last Month');?>
												</label>
											</div>
										</li>
											...
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox" id="pending_lastquarter"
                                                        ...
                                                        ?> onclick="pendingtask('lastquarter',
													'check');"/> <?php echo __('Last Quarter');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox" id="pending_lastyear"
														data-id="lastyear" <?php
                                                            if ($_COOKIE['pending_date_filter'] == 'lastyear') {
                                                                echo "checked";
                                                            }
                                                        ?> onclick="pendingtask('lastyear',
													'check');"/> <?php echo __('Last Year');?>
												</label>
											</div>
										</li>
											...
											<div class="checkbox">
												<label>
													<input class="cst_date_cls" type="checkbox" id="pending_last365days"
                                                        ...
                                                        ?> onclick="pendingtask('last365days',
													'check');"/> <?php echo __('Last 365 days');?>
												</label>
											</div>
										</li>
										...
										<li class="custome_timelog custom_date_li" style="display: none;">
											...
											<div class="frto_sch">
												<input type="text" class="smal_txt form-control "
													placeholder="<?php echo __('From Date');?>"
													readonly id="pendingstrtdt"
													value="<?php echo @$dt[0]; ?>" />
												<input type="text" class="smal_txt form-control "
													placeholder="<?php echo __('To Date');?>"
													readonly id="pendingenddt"
													value="<?php echo @$dt[1]; ?>" />
												<button
													class="btn btn-sm btn-raised  btn_cmn_efect cmn_bg btn-info cdate_btn aply_btn"
								...
								<li class="drop_menu_mc dropdown">
									<a href="javascript:void(0)" class="dropdown-toggle" data-target="#"
										data-toggle="dropdown" onclick="allfiltervalue('pendingtask_status', event);"><i
											class="material-icons">&#xE88B;</i><?php echo __('Status');?></a>
									<ul class="dropdown_status dropdown-menu drop_smenu ltsm scroll-listing"
								...
								<li class="drop_menu_mc">
									<a class="dropdown-toggle" data-toggle="dropdown" data-target="#"
										href="javascript:void(0)" onclick="allfiltervalue('pending_project', event);"><i
											class="material-icons">&#xE8F9;</i><?php echo __('Project');?></a>
									<ul class="dropdown_status dropdown-menu drop_smenu ltsm scroll-listing"
								...
								<li class="drop_menu_mc dropdown">
									<a href="javascript:void(0)" class="dropdown-toggle" data-target="#"
										data-toggle="dropdown" onclick="allfiltervalue('pending_resource', event);"><i
											class="material-icons">&#xE90F;</i><?php echo __('Resource');?></a>
									<ul class="dropdown_status dropdown-menu drop_smenu ltsm scroll-listing"
					...
					<?php } elseif (PAGE_NAME == 'weeklyusage_report') { ?>
					<span
						onclick="<?php if ($GLOBALS['user_subscription']['subscription_id'] != CURRENT_EXPIRED_PLAN) { ?>PrintDiv()<?php } else { ?>alert('<?php echo __("This feature is only available to the paid users! Please Upgrade");?>');<?php } ?>"
						title="<?php echo __('Print this report');?>"
						class="anchor print_w_usage"><i class="material-icons">&#xE8AD;</i></span>
					<!-- <img src="<?php echo HTTP_ROOT . 'img/images/print.png'; ?>"
					style="cursor:pointer">-->
					<?php  } elseif (PAGE_NAME == 'profitable_report') { ?>
					<?php } else {
			...
			<div class="col-lg-12">
				<ul class="proj_stas_bar lft_tab_tasklist acct_set_tab">
					<li <?php
                        ...
                        ?>>
						<a href="<?php echo HTTP_ROOT . 'templates/projects'; ?>"
							class="all-list" id="sett_my_profile">
							<i class="material-icons">&#xE8F9;</i>
							<?php echo __('Project');?>
						</a>
					</li>
					<li <?php
                        ...
                        ?>>
						<a href="<?php echo HTTP_ROOT . 'templates/tasks'; ?>"
							class="all-list" id="sett_cpw_prof">
							<i class="material-icons">&#xE862;</i>
							<?php echo __('Task');?>
						</a>
					</li>
				...
				<div class="col-lg-6 gantt-right-bar">
					<div class="col-lg-6 padrht-non custom-task-fld gantt-month-fld labl-rt add_new_opt mtop10">
						<select class="ganttmnth select form-control floating-label"
							placeholder="<?php echo __('Select Month');?>"
							data-dynamic-opts=true onchange="gantt_filter_mnth(this)">

						</select>
						<input type="hidden" id="gantt_mnth"
							value="<?php echo $_SESSION['ganttchart_month']; ?>" />
					</div>
					<div class="col-lg-6 padrht-non custom-task-fld gantt-year-fld labl-rt add_new_opt mtop10">
						<select class="ganttyr select form-control floating-label"
							placeholder="<?php echo __('Select Year');?>"
							data-dynamic-opts=true onchange="gantt_filter_yr(this)">

						</select>
						<input type="hidden" id="gantt_yr"
							value="<?php echo $_SESSION['ganttchart_year']; ?>" />
					</div>
				</div>
			</div>
		</div>
...
<?php
    ...
    *  */
} elseif ((CONTROLLER == 'projects' && in_array(PAGE_NAME, array('chat_settings'))) || (CONTROLLER == 'users' && PAGE_NAME == 'mycompany') || (CONTROLLER == 'LogTimes' && PAGE_NAME == 'resource_settings') || (CONTROLLER == 'projects' && PAGE_NAME == 'sprint_setting') || (CONTROLLER == 'projects' && PAGE_NAME == 'manageProjectTemplates') || (CONTROLLER == 'projects' && PAGE_NAME == 'project_status') || (CONTROLLER == 'projects' && PAGE_NAME == 'project_types') || (CONTROLLER == 'task_actions' && PAGE_NAME =='duedateChangeReason')) {
    ?>
...
<?php } elseif (CONTROLLER == 'users' && (PAGE_NAME == 'profile' || PAGE_NAME == 'changepassword' || PAGE_NAME == 'email_notifications' || PAGE_NAME == 'email_reports' || PAGE_NAME == 'default_view') || (CONTROLLER == "UserQuicklinks" && PAGE_NAME == "index") || (CONTROLLER == "UserSidebar" && PAGE_NAME == "index")) { ?>
...
<?php } elseif (CONTROLLER == "Defects" && in_array(PAGE_NAME, array('defect_status', 'defect_severity','defect_category','defect_issue_type','defect_activity_type','defect_phase', 'defect_root_cause', 'defect_fix_version', 'defect_affect_version', 'defect_origin', 'defect_resolution'))) {?>
<?php echo $this->element('defect_setting'); ?>
<?php } elseif (CONTROLLER == "Defects" && PAGE_NAME == "defect") { ?>
<div class="task-list-bar templates-bar">
	<div class="wrap_top_tlbar">
		<div class="row">
			<div class="col-lg-12">
				<div class="fr pfl-icon-dv">
					<span id="bug_filter" class="dropdown task_section case-filter-menu">
						<a class="dropdown-toggle dropdown_menu_all_filters_togl" href="javascript:void(0);"
							rel="tooltip"
							title="<?php echo __('Filter');?>"
							onclick="showHideBugFilter();">
							<i class="glyphicon glyphicon-filter"></i>
						</a>
						<div class="dropdown_menu_t dropdown_menu_all_filters_ul_bkp"
							id="dropdown_menu_all_filters_bug">
					...
					<span id="defect_impExp" class="dropdown task_expPrnt case-filter-menu">
						<a class="dropdown-toggle dropdown_menu_exp_print_togl pdf_export" data-toggle="dropdown"
							...
							<ul>
								<li
									onclick="defect_export_csv();trackEventLeadTracker('Top Bar', 'Export To CSV', '<?php echo $_SESSION['SES_EMAIL_USER_LOGIN']; ?>');">
...
<?php } elseif (CONTROLLER == 'Pages' && PAGE_NAME == 'release_activity') { ?>
<div class="task-list-bar dbrd-bar">
	<div class="wrap_top_tlbar">
		<div class="row">
			<div class="col-lg-12">
				<h2><?php echo __('Product Releases');?>
				</h2>
			</div>
		</div>
	</div>
			...
			<div class="col-lg-12">
				<div class="col-lg-7 col-sm-6 m-top-bar">
					<ul class="proj_stas_bar archive_stas_bar">
						<li id="task_li" class="all-list-glyph active-list">
							<a onclick="task()" href="javascript:void(0);" class="all-list">
								<i class="material-icons">&#xE862;</i>
								<?php echo __('Tasks');?>(<span
									class="archive_active_task"></span>)
							</a>
						</li>
						<li id="file_li">
							<a href="javascript:void(0);" onclick="file()">
								<i class="material-icons">&#xE226;</i> <?php echo __('Files');?>
								(<span class="archive_active_file"></span>)
							</a>
						</li>
					</ul>
					<div class="activity-bar">
						<ul class="proj_stas_bar lft_tab_tasklist">
							<li class="activitylist_breadcrumb actvty_li">
								<a id="actvt_btn" class=""
									href="<?php echo HTTP_ROOT . 'dashboard#/activities'; ?>"
									onclick="trackEventLeadTracker('Breadcrumb Navigation','Activities','<?php echo $_SESSION['SES_EMAIL_USER_LOGIN'];?>');return checkHashLoad('activities');">
					...
					<div class="calendar-bar-text">
						<h2><?php echo __('Calendar');?>
						</h2>
					</div>
					<div class="files-bar files-nav-text">
						<h2><?php echo __('Files');?>
						</h2>
					</div>
					<div id="topactions">
						<ul class="lft_tab_tasklist">
							<li class="top_cmn_breadcrumb">
								<a href="javascript:void(0)"
									onclick="trackEventLeadTracker('Breadcrumb Navigation','Common Nav','<?php echo $_SESSION['SES_EMAIL_USER_LOGIN'];?>');showHideTopNav();">
									<i class="material-icons">&#xE8EF;</i> <?php echo __('Task List');?>
								</a>
							</li>
							<li class="top_side_breadcrumb">
								<a href="javascript:void(0)"
									onclick="trackEventLeadTracker('Breadcrumb Navigation','Common Nav Eye','<?php echo $_SESSION['SES_EMAIL_USER_LOGIN'];?>');showHideTopNav();">
									<i class="material-icons" id="tour_calendar_view_v2">keyboard_arrow_down</i>
								</a>
								<ul class="top_cmn_breadcrumb_sub" style="display:none;">
									<li class="tasklist_breadcrumb_v2">
										<a href="<?php echo HTTP_ROOT; ?>dashboard#/tasks"
											onclick="trackEventLeadTracker('Breadcrumb Navigation','Task List','<?php echo $_SESSION['SES_EMAIL_USER_LOGIN'];?>');return checkHashLoad('tasks');">
											<i class="material-icons">&#xE8EF;</i> <?php echo __('Task List');?>
										</a>
									</li>
									...
									<li class="calendar_breadcrumb_v2" id="tour_calendar_view">
										<a href="<?php echo HTTP_ROOT; ?>dashboard#/calendar"
											onclick="trackEventLeadTracker('Breadcrumb Navigation','Calendar','<?php echo $_SESSION['SES_EMAIL_USER_LOGIN'];?>');return calendarView('calendar');">
					...
					<ul class="proj_stas_bar kanban_stas_bar">
						...
						<li id="mlstab_act_kanban_sta" class="all-list-glyph active-list">
							<a href="dashboard#/milestonelist" class="all-list">
								<i class="material-icons">&#xE065;</i>
								<?php echo __('Task Group');?>(<span
									class="kanban_active_task"></span>)
							</a>
						</li>
									...
									<div id="filpopup_kanban" class="dropdown-menu lft popup" style="display: none;">
										<div class="scroll-project" id="ajaxViewFiltersKanban">
											...
											<a href="javascript:void(0);"
												...
												id="kanban_otheropt<?php echo $tabkey; ?>"
												data-val="0"
												data-tabkey="<?php echo $tabvalue["fkeyword"]; ?>"
												rel="" class="gray-background"><?php echo $tabvalue["ftext"]; ?>
												<span
													id="kanban_<?php echo $tab_spn_id; ?>"
													class="spncls"></span></a>
											<?php
                                                        }
                                                    }
						...
						<div class="d_tbl project_overview_bar row" id="tour_overview_statistics">
							<div class="d_tbl_cel col-sm-3 pad_zero">
								<div id="pprog_holder">
									...
									<div class="dyn_overall_abstxt"><?php echo __('Overall Progress');?>
									</div>
								</div>
							</div>
							<div class="d_tbl_cel p_name col-sm-9">
								<div class="proj_name_over_task">
									<div class="proj_name_overtask">
										<h2 id="ov_prj_name"
											title="<?php echo $proj['Project']['name']; ?>">
											<?php echo $proj['Project']['name']; ?>
										</h2>
										<?php if ($this->Format->isAllowed('Edit Project', $roleAccess)) { ?>
										<span id="dsbleInactOver" onclick="inlineUserEdit();"
											class="inline-edit-usr fl anchor" data-prj-id="" data-prj-name=""
											title="<?php echo __('Edit Project');?>"
											rel="tooltip"><i class="material-icons">&#xE254;</i></span>
										<?php } ?>
									</div>
									<div class="edit_status_prior">
										<span id="project_stst_span" class=""
											title="<?php echo __('Project Status');?>"
											rel="tooltip"></span>
										<span class="prio_low prio_lmh prio_gen_prj prio-drop-icon proj_ov_priority"
											rel="tooltip"
											title="<?php echo __('Low Priority');?>"></span>
									</div>
								</div>
							</div>
							<div class="cb"></div>
					...
					<div class="tlog_top_cnt timlog_top_bar">
						...
						<ul id="select_view_timelog" class="proj_stas_bar">
							<li
								...
								<a id="lview_btn_timelog"
									onclick="trackEventWithIntercom('time-log', {'view': 'list'});"
					...
					<div class="tlog_top_cnt timesheet_top_bar">
						...
						<ul id="select_view_timesheet" class="proj_stas_bar ">
							<li
								title="<?php echo __('List View');?>">
								<a id="lview_btn_timelog"
									onclick="return trackEventLeadTracker('Top Bar','List Timelog','<?php echo $_SESSION['SES_EMAIL_USER_LOGIN'];?>');"
									href="<?php echo HTTP_ROOT.'dashboard#/timelog';?>"><i
										class="material-icons">&#xE8EF;</i>&nbsp;<?php echo __('List View');?></a>
							</li>
					...
					<div class="filter_top_cnt filter_top_bar">
						<h2><?php echo __('Manage Filters');?>
						</h2>
						<div class="cb"></div>
					</div>
				</div>
				<div class="col-lg-1 col-sm-1 m-top-bar text-right minheight" data-step="4"
					data-intro="Clicking this will let you 'Save or Update' a new Filter.">
				...
				<div class="col-lg-5 col-sm-5 m-top-bar text-right">
					...
					<div class="fl milst_addition" style="display:none">
						<span class="anchor print_w_usage actv-mls"
							title="<?php echo __('Active Task Groups');?>"
							rel="tooltip" id="actv_btn_tsgrp">
							<a href="javascript:void(0);" onclick="showMilestoneList('', 1)"><i
									class="material-icons">&#xE430;</i></a>
						</span>
						<span class="anchor print_w_usage"
							title="<?php echo __('Completed Task Groups');?>"
					...
					<div class="tag-btn fl archive_filter_det">
						...
						<div class="filter_btn_section ver_midl" id="archive_savereset_filter">
							<span onClick="resetAllFilters_archive('all');" id="archive_reset_btn"
								title="<?php echo __('Reset Filters');?>"><i
									class="material-icons">&#xE8BA;</i></span>
						</div>
					</div>
					<div class="tag-btn fl filter_det">
						...
						<div style="display: table-cell;width: 30px;" class="filter_btn_section ver_midl">
							<button class="btn btn_cmn_efect cmn_bg btn-info" id="saveFilter" onclick="saveFilter();"
								...
								title="<?php echo __('Update Filter');?>"
								rel="tooltip"><i class="material-icons">?</i></button>
						</div>
					</div>
					<div class="new_calendar_icon_on_top">
						<span id="calendar_view_types" style="display:block;"></span>
					...
					<div class="fr pfl-icon-dv">
						<span id="task_filter" class="dropdown task_section case-filter-menu">
							<a class="dropdown-toggle dropdown_menu_all_filters_togl" href="javascript:void(0);"
								rel="tooltip"
								title="<?php echo __('Filter');?>"
								onclick="trackEventLeadTracker('Top Bar', 'Filter', '<?php echo $_SESSION['SES_EMAIL_USER_LOGIN']; ?>');showHidetaskFilter();">
						...
						<span id="overview_exp" class="dropdown timesheet_expPrnt">
							<a id="overview_exp_lnk" href="javascript:void(0)" title="Export as PDF"
								onclick="overviewPDF();" rel="tooltip"><i class="material-icons">picture_as_pdf</i></a>
							<img alt="<?php echo __('loading'); ?>..."
								title="<?php echo __('loading'); ?>..."
								id="ov_pdf_loader"
								src="<?php echo HTTP_IMAGES; ?>images/del.gif"
									...
									<ul class="dropdown_status dropdown-menu drop_smenu ltsm arch-dat"
											...
											<div class="radio radio-primary">
												<label>
													<input class="cst_date_cls" type="radio" data-id="today"
														id="archive_today"
														onclick="checkboxarchivedate('today', 'check');" /> <?php echo __('Today');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="radio radio-primary">
												<label>
													<input class="cst_date_cls" type="radio" data-id="yesterday"
														...
														onclick="checkboxarchivedate('yesterday', 'check');" /> <?php echo __('Yesterday');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="radio radio-primary">
												<label>
													<input class="cst_date_cls" type="radio" data-id="thisweek"
														id="archive_thisweek"
														onclick="checkboxarchivedate('thisweek', 'check');" /> <?php echo __('This Week');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="radio radio-primary">
												<label>
													<input class="cst_date_cls" type="radio" data-id="thismonth"
														...
														onclick="checkboxarchivedate('thismonth', 'check');" /> <?php echo __('This Month');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											...
											<div class="radio radio-primary">
												<label>
													<input class="cst_date_cls" type="radio" data-id="thisyear"
														id="archive_thisyear"
														onclick="checkboxarchivedate('thisyear', 'check');" /> <?php echo __('This Year');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="radio radio-primary">
												<label>
													<input class="cst_date_cls" type="radio" data-id="lastweek"
														id="archive_lastweek"
														onclick="checkboxarchivedate('lastweek', 'check');" /> <?php echo __('Last Week');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											<div class="radio radio-primary">
												<label>
													<input class="cst_date_cls" type="radio" data-id="lastmonth"
														...
														onclick="checkboxarchivedate('lastmonth', 'check');" /> <?php echo __('Last Month');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
											...
											<div class="radio radio-primary">
												<label>
													<input class="cst_date_cls" type="radio" data-id="lastyear"
														id="archive_lastyear"
														onclick="checkboxarchivedate('lastyear', 'check');" /> <?php echo __('Last Year');?>
												</label>
											</div>
										</li>
										<li class="li_check_radio">
										...
										<li class="custome_archive" style="display:none;text-align:center;padding:5px">
											<button class="btn btn_cmn_efect cmn_bg btn-info cmn_size" type="button"
												onclick="arcivecustomdate();" id="btn_archive_search"><?php echo __('Search');?></button>
										</li>
									</ul>
								</li>
								<li class="drop_menu_mc" style="display:none;" id="caseduedate_li">
									...
									<ul class="dropdown_status dropdown-menu drop_smenu ltsm arch-due-dt"
										...
										<li class="custome_archive drop-srch-li"
											...
											<button class="btn btn_cmn_efect cmn_bg btn-info cmn_size" type="button"
												onclick="arcivecustomduedate();" id="btn_archive_search"><?php echo __('Search');?></button>
										</li>
									</ul>
								</li>
								<li class="drop_menu_mc">
						...
						<?php echo $this->element('top_menu_options_icon_v2') ?>
					</div>
