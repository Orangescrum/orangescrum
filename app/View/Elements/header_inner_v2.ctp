<style type="text/css">
	...
	.custom-navbar.nav_inr_menu .right_pfl_menu .quick_tour a .refer_frnd{display: block;margin:0 auto}
	.custom-navbar.nav_inr_menu .right_pfl_menu .quick_tour a small{font-size:12px;display:block;margin: 0;position:relative;bottom:0;}
	.custom-navbar.nav_inr_menu .right_pfl_menu{position:relative}
	.custom-navbar.nav_inr_menu .right_pfl_menu .left_trial.upgrd {
    padding: 0;position: absolute;left: -59px;right: 0;
    margin: auto;display: inline-block;width: 95px; top: 15px;float: none;}
				...
				<div class="right_pfl_menu<?php echo $men_col_class;?>">
									...
									if(!in_array(PAGE_NAME,array('pricing','upgrade_member'))){
										if(!$user_subscription['is_cancel'] && ($user_subscription['subscription_id'] == CURRENT_FREE_PLAN || $user_subscription['subscription_id'] == CURRENT_EXPIRED_PLAN) && SES_TYPE == 1 && SES_COMP != 5303  && SES_COMP != 8728 && SES_COMP != 15602 && SES_COMP != 17945 && SES_COMP != 20414){
											...
											if($days_to_go < 0){
												...
												print "<span class='single_line'><a href='".HTTP_ROOT."users/pricing' class='trial-left' onclick='return trackEventLeadTracker(\'Top Header\',\'Upgrade Now\',\'".$_SESSION['SES_EMAIL_USER_LOGIN']."\');'><button class='btn btn_cmn_efect cmn_bg btn-info cmn_size upgrd_btn ".$col_class."' type='button'>".__('Upgrade Now')."</button></a></span>";
											}
											}else{
											print '&nbsp;';
										}						
					...
					<ul class="nav navbar-nav profile-bar">
						...
						<li class="upgrade_plan_li">
							<a href="https://www.orangescrum.com/pricing" target="_blank" title="Upgrade" class="quick_link_btn upgrd_btn">Upgrade</a>
						</li>
						<?php if(PAGE_NAME != "updates" && PAGE_NAME != "help" && PAGE_NAME != "tour" && PAGE_NAME != "customer_support" && PAGE_NAME !='onbording'){ ?>
							...
							<li class="nav-profile-dropdown nav-notification-bar quick-add-drop dropdown hover-menu cmn_parent_navli vline">
								<a class="dropdown-toggle" data-target="#" href="javascript:void(0)" data-toggle="dropdown"  title="<?php echo __('Help & Support'); ?>" rel="tooltip_bot">
								...
								<div class="dropdown-menu border-box top_maindropdown-menu fadeout_bkp help_updates">
									<ul class="notification-ul">
										<li><a href="<?php echo WHATS_NEW_URL; ?>" target="_blank">What's New</a></li>
										<li><a href="<?php echo HELPDESK_URL; ?>" target="_blank">Help</a></li>
										<li><a href="<?php echo SUPPORT_URL; ?>" target="_blank">Support</a></li>
										<li><a href="<?php echo COMMUNITY_FORUM_URL; ?>" target="_blank">Community Forum</a></li>
										<li><a href="https://www.orangescrum.com/contact-support?feedback=feedback" >Submit Feedback</a></li>
										<li id="feature_list"><a href="<?php echo HTTP_ROOT; ?>pages/allFeatureList" >Premium Features</a></li>
									</ul>
									<div class="cb"></div>
								</div>
							</li>
