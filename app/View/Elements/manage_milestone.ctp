    ...
    <div class="col-lg-12 m-left-42 prj_div">
	    <div class="col-lg-4">
            <div class="col-lg-12 contain new_prjct text-centre" style="padding:0;">
                <a href="javascript:void(0);" onClick="addEditMilestone(this);" data-id="" data-uid="" data-name="" style="display: block !important;padding:59px 55px;">
		...
		<div class="col-lg-4 proj_mng_div">
			<div class="col-lg-12 contain usr_mng_div milestone_div">
                ...
                <div class="user-details prj_details">
                    ...
                    <div class="fl usr_rt">
                    <div class="border_usr"><b><span id="tot_tasks<%= milestoneAutoId %>"><%= total_cases %></span></b> <?php echo __('Tasks');?></div>
                    <div><b><%= closed_cases %></b> <?php echo __('Closed');?></div>
...
-->			
                ...
                <div class="proj_mng">
				    <div class="fl">
					<a href="javascript:void(0);" class="icon-add-task fl" onClick="addTaskToMilestone(this);" data-prj-id="<%= projId %>" data-id="<%= milestoneAutoId %>"><?php echo __('Move Task');?></a>
					<br />
					<% if(mlsttype=='0'){ %>
						<a href="javascript:void(0);" class="icon-restore-mlstn fl" onClick="milestoneRestore(this);" data-uid="<%= milestoneUniqId %>" data-name="<%= milestoneTitle %>"><?php echo __('Restore');?></a>
					<% }else{ %>
						<a href="javascript:void(0);" class="icon-complete-mlstn fl" onClick="milestoneArchive(this);" data-uid="<%= milestoneUniqId %>" data-name="<%= milestoneTitle %>"><?php echo __('Complete');?></a>
					<% } %>
					<% if(total_cases>0){ %><br/>
						<a href="javascript:void(0);" class="icon-remov-task fl" onClick="removeTaskFromMilestone(this);" data-prj-id="<%= projId %>" data-id="<%= milestoneAutoId %>"><?php echo __('Remove Task');?></a>
					<% } %>
				    </div>
				    <div class="fr">
					<a href="javascript:void(0);" class="icon-edit-mlstn fl" onClick="addEditMilestone(this);" data-id="<%= milestoneAutoId %>" data-uid="<%= milestoneUniqId %>" data-name="<%= milestoneTitle %>"><?php echo __('Edit');?></a>
					<br />
					<a href="javascript:void(0);" class="icon-delete-mlstn fl" onClick="delMilestone(this);" data-uid="<%= milestoneUniqId %>" data-name="<%= milestoneTitle %>"><?php echo __('Delete');?></a>
				    </div>
				</div>
			</div>
		</div>
