<div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 id="label_title_wfsts"><?php echo __('Create New Status');?></h4>
        </div>
            ...
            <div id="inner_label">
                <center><div id="lterr_msg" class="err_msg"></div></center>               
                    <div class="form-group label-floating">
                     ...
                     <div class="form-group label-floating">
                        <label class="control-label" for="label_nm"><?php echo __('Map to');?></label>
                        <select name="data[StatusGroup][map_to]" class="select2">
