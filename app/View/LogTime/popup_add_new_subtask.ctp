    ...
    <div class="modal-content">
        ...
        <div class="modal-body popup-container">
			<div class="row" style="margin-top:15px;margin-bottom:15px;">
				...
				<div class="col-lg-12 col-sm-12 col-xs-12 select2__wrapper">
					<div class="form-group label-floating custom-task-fld title-fld top-tsk-ttl ct-title">
						<label class="control-label dtlpopup" for="CS_title"><?php echo __('Task Title');?></label>
						<input class="form-control <?php if(SES_COMP == 33179 || SHOW_ARABIC){ ?>arabic_rtl<?php } ?>" id="CS_title_pop" type="text" maxlength='240' />
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-4 mtop15  <?php if(!$this->Format->isAllowed('Est Hours',$roleAccess)){ ?>no-pointer<?php } ?>">
					<div class="field_wrapper nofloat_wrapper" rel="tooltip" title="<?php echo __('You can enter time as 1.5  (that  mean 1 hour and 30 minutes)');?>.">
						<input type="text" onkeypress="return numeric_decimal_colon(event),mins_validation(this)" id="sub_estimated_hours" name="data[Easycase][estimated_hours]" maxlength="5" class="ttfont est check_minute_range" value="<?php if(isset($taskdetails['estimated_hours']) && $taskdetails['estimated_hours']){echo $taskdetails['estimated_hours'];}?>" placeholder="hh:mm" onchange="mins_validation(this);setStartDueDt();">
