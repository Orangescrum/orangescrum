<?php if(isset($recent_projects) && !empty($recent_projects)) {
	...
	<div class="listdv">
	   ...
	   <div class="fr imprv_bar col-lg-4" style="margin: 5px 0;" title="<?php echo $total_progress;?>%" rel="tooltip">
	    ...
	    <div class="cb"></div>
	    <div class="fl status-dta"><?php echo __('Created on');?> <?php echo $created;?></div>
	    <div class="fr status-dta"><?php echo $value['0']['resolved'];?> of <?php echo $value['0']['total'];?> <?php echo __('Tasks Resolved');?></div>
	    <div class="cb"></div>
	...
	<div id="recent_projects_more" data-value="<?php echo $total;?>" style="display: none;"></div>
     <?php } else { ?>
    <div class="fnt_clr_rd"><?php echo __('No project found');?>.</div>
