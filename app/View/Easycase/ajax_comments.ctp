			...
			<tr height="20px" >
				...
				<td align="right" valign="middle">
					...
					<span id="hoverPost<?php echo $cmntId; ?>" style="display:none;">
						<a href="javascript:void(0);" onclick="postCommentsEdit('<?php echo $cmntId; ?>','cmntxt<?php echo $cmntId; ?>','cmntspan<?php echo $cmntId; ?>','cmntxa<?php echo $cmntId; ?>','hoverEdit<?php echo $cmntId; ?>','hoverPost<?php echo $cmntId; ?>','','')"><?php echo __('Save');?></a>
						<font size="1">or</font>
			...
			<tr>
				<td colspan="2" align="left" style="color:#7B94C3;">
					...
					if($cmnt['CaseComment']['user_id'] != SES_ID) {
						...
						$shortName = __("me",true);
					}
					?> <?php echo __('by');?> <?php echo $shortName; ?>
				</td>
			</tr>
		</table>
		</div>
