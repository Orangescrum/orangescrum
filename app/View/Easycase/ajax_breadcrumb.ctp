<table cellpadding="0" cellspacing="0" border="1">
	<tr>
		...
		<td align="left">
			<a href="javascript:jsVoid();" id="statusRefresh-root" onclick="showHideDropDown('statusRefresh')"><?php echo __('Status');?></a>
		...
		<td align="left">
			...
			if($types) { echo substr($types,0,-2); } else { echo __("All"); }
			?>
			&nbsp;
		</td>
		<td align="left">
			<a href="javascript:jsVoid();" id="statusTypes-root" onclick="showHideDropDown('statusTypes')"><?php echo __('Types');?></a>
		...
		<td align="left">
			...
			if($pri) { echo substr($pri,0,-2); } else { echo __("All"); }
			?>
			&nbsp;
		</td>
		<td align="left">
			<a href="javascript:jsVoid();" id="prioritRefresh-root" onclick="showHideDropDown('prioritRefresh')"><?php echo __('Priority');?></a>
		...
		<td align="left">
			...
			if($mems) { echo substr($mems,0,-2); } else { echo __("All"); }
			?>
			&nbsp;
		</td>
		<td align="left">
			<a href="javascript:jsVoid();" id="csMemAjx-root" onclick="showHideDropDown('csMemAjx')"><?php echo __('Members');?></a>
		...
		<td align="left">
			...
			{
				$resVal = 1;
				echo ",&nbsp;".__('Search').": <i>".$case_search."</i>";
				$jsSearch = "setSearchValue();";
			}
			if(isset($resVal) && $resVal)
			{
			?>
				&nbsp;&nbsp;&nbsp;<a href="javascript:jsVoid();" class="button-link" rel="tooltip" title="<?php echo __('Reset Filters');?>" onClick="<?php echo $jsSearch; ?>resetAllFilters();ajaxCaseView('case_project.php');" style="padding:0px 4px;font-size:11px;"><?php echo __('Reset');?></a>
			<?php
			}
			?>
		</td>
