...
if(isset($milestones)){
	...
	<li class="slide_menu_div1">
		<a href="javascript:void(0);">
		    <input type="radio" name="data['milestone]" value="all" id="allmstones" onclick="checkMilestones('all')" <?php if (!$cookies || $cookies == 'all' || $isAll) { echo "checked"; } ?> class="milestone_fliter_cls" style="cursor:pointer"/>&nbsp;<b><?php echo __('All');?></b>
		</a>	
	</li>	
	<?php
