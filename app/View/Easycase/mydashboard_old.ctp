...
.cmpl_gblue{height:40px;margin: 0px;padding: 12px 0;text-align: center;float: left;color:#fff;}
</style>
...
<div class="left-board" id="my_left-board" <?php if(SES_TYPE == 1 || SES_TYPE == 2 || IS_MODERATOR == 1){ ?> style="display:block" <?php }else{ ?> style="display:none;" <?php } ?>>
  ...
  <ul>
    <li><a href="javascript:void(0);" id="intro-to-video"><span><img src="<?php echo HTTP_IMAGES; ?>images/i-collaborate.png" title="Collaborate"/></span> <span>How to<br/>Collaborate</span></a></li>
    <li><a href="/task-type" target="_blank"><span><img src="<?php echo HTTP_IMAGES; ?>images/i-custom.png" title="Custom"/></span> How to<br/>Customize Task</a></li>
    <li><a href="/tour/respond" style="margin-right:0px;"  target="_blank"><span><img src="<?php echo HTTP_IMAGES; ?>images/i-use.png" title="Use"/></span> How to use<br/>on the go</a></li>
  </ul>
  <div class="cb"></div>
</div>
<div class="task-status" id="my_task-status" <?php if(SES_TYPE == 1 || SES_TYPE == 2 || IS_MODERATOR == 1){ ?> style="display:block;" <?php }else{ ?> style="display:block;margin-top:35px;" <?php } ?>>
  <h5>Task Status</h5>
  <div class="status-bar">
    <div id="new_task_proj" class="cmpl_gblue" rel="tooltip" ></div> 
    <div id="wip_task_proj" class="cmpl_gblue" rel="tooltip" ></div> 
    <div id="resolved_task_proj" class="cmpl_gblue" rel="tooltip" ></div>
    <div id="closed_task_proj" class="cmpl_gblue" rel="tooltip" ></div>
  </div>
    <div class="cb"></div>
  <div class="color-hint">
  <ul>
    <li><span class="wd new-red"></span><span>New</span></li>
    <li><span class="wd progress-blue"></span><span>In Progress</span></li>
    <li><span class="wd resolved-org"></span><span>Resolved</span></li>
    <li><span class="wd closed-green"></span><span>Closed</span></li>
  </ul>
  <div class="cb"></div>
  </div>
...
<ul class="sortable" id="ul_mydashboard">
	...
	<div class="sort_li_inner">
	    ...
	    <div class="loader_dv_db" id="task_types_ldr" style="display: none;margin-top: 90px;"><center><img src="<?php echo HTTP_IMAGES; ?>images/case_loader2.gif" alt="Loading..." title="Loading..." /></center></div>
	</div>
    </li>
    <li class="sortable-li" id="list_pie_chart" style="<?php if(PROJ_UNIQ_ID!='all'){ ?>display:none<?php } ?>">
	    ...
	    <div id="task_status_pie" class="dboard_cont"></div>
            <div class="loader_dv_db" id="task_status_ldr_pie" style="display: none;margin-top: 90px;"><center><img src="<?php echo HTTP_IMAGES; ?>images/case_loader2.gif" alt="Loading..." title="Loading..." /></center></div>
        </div>
    </li>
...
<div class="working-btn">
  <ul>
    <li <?php if(SES_TYPE == 1 || SES_TYPE == 2 || IS_MODERATOR == 1){ ?> style="display:block" <?php }else{ ?> style="display:none;" <?php } ?>><a href="javascript:void(0);" onclick="newUser()" class="i-collaborate"><span><img src="<?php echo HTTP_IMAGES; ?>images/i-invite.png" title="Add New User"/></span> <span id="invt_mor_user">Add New User</span></a></li>
    <li><a href="javascript:void(0);" onclick="newProject();" class="i-use"><span><img src="<?php echo HTTP_IMAGES; ?>images/i-projct.png" title="Project"/></span> <span id="cret_anthor_proj">Create Project</span></a></li>
    <li><a href="javascript:void(0);" onclick = "addEditMilestone(this,'','','','','dashboard');" class="i-custom"><span><img src="<?php echo HTTP_IMAGES; ?>images/i-milestone.png" title="Milestone"/></span> <span id="cret_fst_milestone">Create Milestone</span></a></li>
  </ul>
  <div class="cb"></div>
