...
<table cellpadding="4" cellspacing="4" border="0" width="100%" bgcolor="#FFFFFF">
	<tr>
			...
			<table cellpadding="10" cellspacing="10" border="0" style="font-weight:bold;" bgcolor="#FFFFFF">
				<tr>
					...
					<td align="left" class="case_lebel" width="270px">
						...
						if(count($projArr) == 0)
						{
							echo "<span style='font-weight:normal;color:#FF0000;'>".__('yet to assign')."!</span>&nbsp;&nbsp;&nbsp;&nbsp;";
							?>
						...
						<span id="leb_pri" <?php if($sel_mytype == 10) { echo "style='display:none'"; } ?>>
							...
							<select name="data[Easycase][priority]" id="sel_casePri" class="case_fields" style="width:80px">						  
								...
								?>
									...
									?>
									value="<?php echo $pri; ?>">
									<?php if($pri == 0) { echo __("High"); } elseif($pri == 1) { echo __("Medium"); } else { echo __("Low"); } ?>
									</option>
								<?php
								}
								?>
				...
				<tr>
					<td align="right" class="case_lebel" valign="top" style="padding-top:10px;">
						<?php echo __('Attachment');?>:<br/><font style="font-size:12px;color:#008000;">(<?php echo __('optional');?></font>
					</td>
				...
				<tr>
					...
					<span id='sub_post'>
						...
						<button type="submit" value="Post & Continue" name="data[Easycase][postdata]" style="margin-left:3px;margin-top:5px;width:120px" class="blue small"><?php echo __('Post & Continue');?></button>
						<button type="submit" value="Post & View List" name="data[Easycase][postdata]" style="margin-left:3px;margin-top:5px;width:120px" class="blue small"><?php echo __('Post & View List');?></button>
						or
						<a href="<?php echo HTTP_ROOT; ?>dashboard"><?php echo __('Cancel');?></a>
					</span>
		...
		<td width="200px" valign="top" style="font-size:14px;">
			<strong><?php echo __('Legends');?></strong>
