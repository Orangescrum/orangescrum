...
<table cellpadding="0" cellspacing="0" border="1">
	<tr>
		...
		<td align="left">
			...
			{
				$resVal = 1;
				echo "<div class='fl wrapword'>&nbsp;".__('Search').": <i>".$case_search."</i></div>";
				$jsSearch = "setSearchValue();";
			}
			if(isset($resVal) && $resVal) {
			?>
				<div style="position:relative" class="fl">
					&nbsp;&nbsp;<a href="javascript:jsVoid();" class="button-link" title="<?php echo __('Reset Filters');?>" onClick="<?php echo $jsSearch; ?>resetAllFilters('all');ajaxCaseView('case_project.php');" style="padding:0px 4px;font-size:11px;"><?php echo __('Reset');?></a>
					<!--<div class="reset_indication"><img src="<?php HTTP_ROOT ?>img/images/reset_indication.png" /></div>-->
					<div class="reset_indication">
						<div class="fl"><?php echo __('click to Reset Filters');?></div><div align="right" class="fr close_reset" style="position:relative; left:6px; top:-6px; font-size:10px; cursor:pointer">x</div>
