<table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
	<tr>
		<td align="left" style="padding:2px;font-size:20px;text-shadow: 0 1px 1px #B3B3B3;font-weight: bold;text-shadow: 0 1px 1px #B3B3B3;">
			<h1 class="toplink"><?php echo __('Archive');?> > <?php echo __('Files');?></h1>
		</td>
	</tr>
	<tr>
		<td> <br><br>
			...
			<table border="1" style="border:1px solid #CFD7DD" width="100%">
				<tr bgcolor="#CFD7DD" style="font-weight:bold;color:#333333;padding-left:5px;" height="25px"  valign="top">
					...
					<td  style="padding-left:4px;" align="left"><?php echo __('File Name');?></td>
					<td  style="width:100px" align="center"><?php echo __('Type');?></td>
					<td  style="width:100px" align="center"><?php echo __('Size (Kb)');?></td> 
					...
					<td  style="padding-left:4px;width:80px;" align="center"><?php echo __('Action');?></td>
				</tr>
				<?php 
					$repeatLastUid = "";
					$clas = "";
