<tr>
  <td style="vertical-align: top;"><?php echo __('Filter Name');?>:</td>
  <td style="vertical-align: top;">
	  <?php echo $this->Form->text('name',array('value'=>'','class'=>'form-control','id'=>'savefilter_name')); ?>
	  <div class="eror_txt" style="display: none;"><?php echo __('Name cannot be left blank');?>!</div>
...
<tr>
  ...
  <td align="left">  	  
	  ...
	  <div id="saveFilBtn" style="display:block;">	  
	      <button type="submit" value="Create" class="btn gry_btn btn_pop fl" onclick="submitfilter();"><?php echo __('Save');?></button>
	      <button type="button" value="Cancel" class="btn gry_btn btn_pop fl" onClick="closePopup();"><?php echo __('Cancel');?></button>
	  </div>
