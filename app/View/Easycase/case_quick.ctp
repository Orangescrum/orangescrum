...
<script type="text/javascript">
	...
	function showTemplates(id,name) {
		...
		if(GetContent && id != "New"){ //It will check whether data is present or not and Not Reseting the field
			if(confirm("<?php echo __('Your description will be replaced by this');?> \""+name+"\" <?php echo __('Template');?>")){
				isDataPresent = true;
			}else{
				isDataPresent = false;
			}
...
<input type="hidden" id="CS_due_date" value="<?php if(isset($taskdetails) && $taskdetails['due_date']){echo date('m/d/Y',strtotime($taskdetails['due_date']));}else{?><?php echo __('No Due Date');?><?php }?>">
									...
									<div class="opt1" id="opt1">
										<a href="javascript:jsVoid()" onclick="open_more_opt('more_opt');">
											...
											<?php if(isset($taskdetails) && $taskdetails['type_id']){
												...
												<img class="flag" src="<?php echo HTTP_IMAGES.'images/types/dev.png';?>" alt="type" style="padding-top:3px;"/>&nbsp;<?php echo __('Development');?>
											<?php }?>
											</span> 
...
<div class="case_field">
	<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td align="left">
					<div class="fl lbl-m-wid" style="padding-top:17px"><?php echo __('Due Date');?>:</div>
					<div class="col-lg-9 fl rht-con">	
						<div class="fl dropdown option-toggle p-6">
							...
							<div class="more_opt" id="more_opt3">
								<ul>
									<li><a href="javascript:jsVoid()">&nbsp;&nbsp;<?php echo __('No Due Date');?><span class="value"><?php echo __('No Due Date');?></span></a></li>

									<li><a href="javascript:jsVoid()">&nbsp;&nbsp;<?php echo __('Today');?><span class="value"><?php echo date('m/d/Y',strtotime($userDate));?></span> </a></li> 	
									<li><a href="javascript:jsVoid()">&nbsp;&nbsp;<?php echo __('Next Monday');?> <span class="value"><?php echo date('m/d/Y',strtotime($monday));?></span></a></li> 
									<li><a href="javascript:jsVoid()">&nbsp;&nbsp;<?php echo __('Tomorrow');?><span class="value"><?php echo date('m/d/Y',strtotime($tomorrow));?></span></a></li>
									<li><a href="javascript:jsVoid()">&nbsp;&nbsp;<?php echo __('This Friday');?><span class="value"><?php echo date('m/d/Y',strtotime($friday));?></span></a></li> 
			...
			<td id="task_priority_td" >
				<table cellpadding="0" cellspacing="0">
					<tr>
						...
						<td align="left">
							<div class="fl prio_radio y_low" onclick="check_priority(this);" ><input type="radio" name="task_priority" value="2" id="priority_low" <?php if(isset($taskdetails['priority']) && $taskdetails['priority']==2){?>checked="checked"<?php }?> />&nbsp;<?php echo __('Low');?>&nbsp;&nbsp;</div>
							<div class="fl prio_radio g_mid" onclick="check_priority(this);"><input type="radio" name="task_priority" value="1" id="priority_mid"  <?php if(!isset($taskdetails['priority'])){?>checked="checked"<?php }elseif($taskdetails['priority']==1){?>checked="checked"<?php }?>  />&nbsp;<?php echo __('Medium');?>&nbsp;&nbsp;</div>
							<div class="fl prio_radio h_red" onclick="check_priority(this);"><input type="radio" name="task_priority" value="0" id="priority_high" <?php if(isset($taskdetails['priority']) && $taskdetails['priority']==0){?>checked="checked"<?php }?> />&nbsp;<?php echo __('High');?>&nbsp;&nbsp;</div>
							<?php /*<span id="hd2">
								<div class="fl dropdown option-toggle p-6">
...
<table cellpadding="0" cellspacing="0">
	<tr>
		<td class="case_fieldprof" >
			<div class="fl lbl-m-wid"><?php echo __('Hour(s) Spent');?>:</div>
		</td>
		<td>
						...
						<td>
							<form id="file_upload" action="<?php echo HTTP_ROOT."easycases/fileupload/?".time(); ?>" method="POST" enctype="multipart/form-data">
								<div class="fl" style="margin:10px 0;">
									...
									<div style="margin-left:6px" class="fnt999"><?php echo __('Max size');?> <?php echo MAX_FILE_SIZE; ?> <?php echo __('Mb');?></div>
								</div>
...
<script src="<?php echo JS_PATH; ?>client.js" defer></script>
<?php } ?>
<!-- Google drive ends-->
<?php if(!in_array(SES_COMP,Configure::read('REMOVE_DROPBOX_GDRIVE'))){ ?>
...
<script type="text/javascript">
	...
	function validate_quick_case(){
		if(document.getElementById("title_txt").value==''){
			alert("<?php echo __('Title Field Can Not Be Left Blank');?>");
			return false;
		}else{
			return true;
		}
