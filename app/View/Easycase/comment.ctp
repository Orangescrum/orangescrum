<table cellpadding="0" cellspacing="0" width="100%" onmouseover="displayEdit('hover<?php echo $cmntId; ?>')" onmouseout="hideEdit('hover<?php echo $cmntId; ?>')" >
		...
		<td align="right" valign="middle">
			<span style="display:none;" id="hover<?php echo $cmntId; ?>">
				<span id="hoverEdit<?php echo $cmntId; ?>">
					<img src="<?php echo HTTP_IMAGES; ?>images/comments.gif" border="0" style="text-decoration:none;"/><a href="javascript:void(0);" onclick="openCommentEdit('cmntxt<?php echo $cmntId; ?>','cmntspan<?php echo $cmntId; ?>','cmntxa<?php echo $cmntId; ?>','hoverEdit<?php echo $cmntId; ?>','hoverPost<?php echo $cmntId; ?>')"><?php echo __('Edit');?></a>
				</span>
				<span id="hoverPost<?php echo $cmntId; ?>" style="display:none;">
					<a href="javascript:void(0);" onclick="postCommentsEdit('<?php echo $cmntId; ?>','cmntxt<?php echo $cmntId; ?>','cmntspan<?php echo $cmntId; ?>','cmntxa<?php echo $cmntId; ?>','hoverEdit<?php echo $cmntId; ?>','hoverPost<?php echo $cmntId; ?>','<?php echo $repid; ?>','<?php echo $count; ?>')"><?php echo __('Save');?></a>
					<font size="1">or</font>
					<a href="javascript:void(0);" onclick="openCommentEdit('cmntxt<?php echo $cmntId; ?>','cmntspan<?php echo $cmntId; ?>','cmntxa<?php echo $cmntId; ?>','hoverEdit<?php echo $cmntId; ?>','hoverPost<?php echo $cmntId; ?>')"><?php echo __('Cancel');?></a>
				</span>
			</span>
		</td>
	</tr>
	...
	<tr>
		<td align="left" style="padding:5px 5px;">
			...
			<span class="exp_menu" style="cursor:pointer;" onclick="hideShowImg('showimgdtls<?php echo $cmntId; ?>','shTxt<?php echo $cmntId; ?>')">
				&nbsp;<font style="font-size:12px;color:#03F;cursor:pointer;text-decoration:underline;font-weight:normal;" id="shTxt<?php echo $cmntId; ?>"><?php echo __('Show Images');?></font>
			</span>
	...
	<tr>
		<td colspan="2" align="left" style="color:#7B94C3;">
			<?php echo __('2 seconds ago by me');?>
		</td>
	</tr>
</table>
