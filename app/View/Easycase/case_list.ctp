<table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
	<tr>
		<td align="left" style="padding:2px;font-size:20px;text-shadow: 0 1px 1px #B3B3B3;font-weight: bold;text-shadow: 0 1px 1px #B3B3B3;">
			<h1 class="toplink"><?php echo __('Archive');?> > <?php echo __('Tasks');?></h1>
		</td>
	</tr>
	<tr>
	<td>
		<a href="javascript:void(0)" onclick="caseall()"><?php echo __('All');?></a>
		<a href="javascript:void(0)" onclick="casenone()"><?php echo __('None');?></a>
		<a href="javascript:void(0)" onclick="restoreall()"><?php echo __('Restore');?></a>
		<a href="javascript:void(0)" onclick="removeall()"><?php echo __('Remove');?></a>
	</td>
	</tr>
	<tr>
		<td>
			...
			<table border="1" style="border:1px solid #CFD7DD" width="100%">
				<tr bgcolor="#CFD7DD" style="font-weight:bold;color:#333333;padding-left:5px;" height="25px"  valign="top">
					...
					<td  style="width:40px;" align="center"><?php echo __('Task');?>#</td>
					<td  style="padding-left:4px;" align="left"><?php echo __('Title');?></td>
					<td  style="padding-left:4px;width:80px;" align="left"><?php echo __('Status');?></td>
					<td  style="padding-left:4px;width:140px;" align="left"><?php echo __('Project');?></td>
					<td  style="padding-left:4px;width:160px;" align="left"><?php echo __('Archive Date');?></td>
					<td align="center" width="80px"><?php echo __('Action');?></td>
				</tr>
			<?php
				$repeatLastUid = "";
				$clas = "";
