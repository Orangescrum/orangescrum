...
{
	var conf = confirm("<?php echo __('Are you sure you want to delete');?> '"+name+"' ?");
	if(conf == true)
	{
		return true;
	}
          ...
          <td>
               <div id="active_div" class="ui-tabs" style="display:block">
                    <ul class="ui-tabs-nav" id="ui-tabs-nav">
                         <li style="margin-left:-15px;" id = "activeli" <?php if($projtype == '') { ?>class="class_active" <?php }?>><a id="active"  href="<?php echo HTTP_ROOT."projects/".PAGE_NAME; ?>" ><?php echo __('Active');?></a></li>
                         <li id = "completeli" <?php if($projtype == 'disabled') { ?>class="class_active" <?php }?>><a id="complete"  href="<?php echo HTTP_ROOT."projects/".PAGE_NAME."/disabled"; ?>" ><?php echo __('Inactive');?></a></li>
                    </ul>
				</div>
			  <div class="popup_link_status link_as_drp_dwn fr" id="expimpdiv">
					<a href="javascript:jsVoid();" id="exportimport-root" style="font-style:normal; text-decoration:none" original-title="<?php echo __('Click to Export');?>/<?php echo __('Import CSV');?>" onclick="view_exportimport_menu();"><font style="font-size:12px;">
						<span class="pname_dashboard"><?php echo __('Download');?>/<?php echo __('Upload CSV');?></span>&nbsp; 
			  ...
			  <div class="popup1" style="display:none;position:absolute;right:0px;top: 25px; " id="expimppopup">
				...
				<div class="popup_con_menu" align="left" style="left:-24px;min-width:100px;">
					<a href="javascript:void(0);" onclick="ajax_exportCsv(1);"><?php echo __('Download');?></a>
					<a href="<?php echo HTTP_ROOT;?>projects/importexport/<?php echo $getallproj[0]['Project']['uniq_id'];?>"><?php echo __('Upload');?></a>
				</div>
			</div>
          </td>
     </tr>
...
<table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
		...
		<td align="left" colspan="2">
			<table border="0" style="border:1px solid #DCDCDC" width=100%>
				<tr height="28px">
					...
					<td style="font-weight:bold;color:#333333;" align="center" width="120px" class="tophead">
						<?php echo __('Storage (MB)');?><?php /*?><br>(Max. <?php echo MAX_SPACE_USAGE; ?> Mb)<?php */?>
					</td>
					<td style="font-weight:bold;color:#333333;" align="center" width="140px" class="tophead">
						<?php echo __('Latest Activity');?>
					</td>
					<td style="font-weight:bold;color:#333333;" align="center" width="120px" class="tophead">
						<?php echo __('Action');?>
					</td>
				...
				<tr class="<?php echo $clas?>" height="25px" id="userlist<?php echo $count;?>" <?php if($prjAllArr['Project']['isactive'] == 2) { ?> style="background-color:#FEE2E2;" <?php } ?>>	
					<td style="padding-left:5px;">
						<a href="javascript:void(0);" class="classhover" rel="tooltip" original-title="<?php echo __('Click here to view users');?>" onclick="openusers('<?php echo $count;?>');userListing('<?php echo $count;?>','<?php echo $prjAllArr['Project']['id'];?> ')">
							...
							<tr>
								...
								<td style="padding:0 4px">
									<!--<a href="javascript:void(0);" class="makeHover">-->
										...
										<a href="javascript:void(0);" class="makeHover" onClick="openUsPopup('add_user','<?php echo $prjAllArr['Project']['id']; ?>','<?php echo urlencode($prjAllArr['Project']['name']); ?>','<?php echo $count;?>')"><div class="act_user_new"  rel=tooltip  title="<?php echo __('Add user');?>"></div></a>
								...
								<td style="padding:0 4px">
									...
									?>
										<a href="javascript:void(0);" onClick="setprojectAction('delete','<?php echo $projName?>','<?php echo $prjAllArr['Project']['id']?>','<?php echo HTTP_ROOT; ?>projects/gridview/');" class="makeHover">
											<div class="act_del" style="margin-left:3px;" rel=tooltip  title="<?php echo __('Delete');?>"></div>
										</a>
									<?php
									}
									else {
									?>
										<a href="javascript:void(0);"  onClick="setprojectAction('deactivate','<?php echo $projName?>','<?php echo $prjAllArr['Project']['id']?>','<?php echo HTTP_ROOT; ?>projects/gridview/');" class="makeHover"><div class="act_dis" style="margin-left:3px;" rel=tooltip  title="<?php echo __('Inactive');?>"></div></a>
									<?php
									}
									?>
								</td>
								<?php
									...
									<td style="padding:0 4px">
										...
										if($totCase == 0) {
										?>
											<a href="javascript:void(0);" onClick="setprojectAction('delete','<?php echo $projName?>','<?php echo $prjAllArr['Project']['id']?>','<?php echo HTTP_ROOT; ?>projects/gridview/');" class="makeHover"><div class="act_del" style="margin-left:3px;" rel=tooltip  title="<?php echo __('Delete');?>"></div></a>
											
										<?php
										}
										else {
										?>
											<a href="javascript:void(0);" onClick="setprojectAction('activate','<?php echo $projName?>','<?php echo $prjAllArr['Project']['id']; ?>','<?php echo HTTP_ROOT; ?>projects/gridview/');" class="makeHover"><div class="act_dis" style="margin-left:3px;" rel=tooltip  title="<?php echo __('Active');?>"></div></a>
										<?php
										}
										?>
									</td>
				...
				<tr><td style="color:#666666;padding:10px" colspan="8" align="center">
					...
					if($projtype)
					{
                              if($prjsrch){
                                   ...
                                   <div style="padding-top:5px;"><a href="<?php echo HTTP_ROOT; ?>projects/gridview/disabled" style="color:#0000FF;font-weight:normal;"><?php echo __('View All');?></a></div>
                              <?php }else{
                                   echo __("No inactive project!");
                              }
					...
					else
					{
                              if($prjsrch){
                                   echo __("No Results Found"); ?>
                                <div style="padding-top:5px;"><a href="<?php echo HTTP_ROOT; ?>projects/gridview/" style="color:#0000FF;font-weight:normal;"><?php echo __('View All');?></a></div>
                              <?php }else{
                                   echo __("No project!");
                              }
						?>
	...
	<tr>
		<td style="font-size:14px;" colspan="2"><?php echo __('Total storage used');?>: <b><?php echo $space; ?></b> Mb</td>
	</tr>
						...
						if($page_limit < $caseCount){
							...
							if($data1){
                                         if($projtype == 'disabled'){
                                             echo "<li><a href='".HTTP_ROOT."projects/gridview/disabled?page=1' class=\"button_act\">&laquo; ".__('First')."</a></li>";
                                        }else{
                                             echo "<li><a href='".HTTP_ROOT."projects/gridview?page=1' class=\"button_act\">&laquo; ".__('First')."</a></li>";
                                        }
							...
							if($page != 1){
								$pageprev = $page-1;
                                        if($projtype == 'disabled'){
                                             echo "<li><a href='".HTTP_ROOT."projects/gridview/disabled?page=".$pageprev."' class=\"button_act\">&lt;&nbsp;".__('Prev')."</a></li>";
                                        }else{
                                             echo "<li><a href='".HTTP_ROOT."projects/gridview?page=".$pageprev."' class=\"button_act\">&lt;&nbsp;".__('Prev')."</a></li>";
                                        }
							...
							if(($caseCount - ($page_limit * $page)) > 0){
								$pagenext = $page+1;
                                        if($projtype == 'disabled'){
                                             echo "<li><a href='".HTTP_ROOT."projects/gridview/disabled?page=".$pagenext."' class=\"button_act\" >".__('Next')."&nbsp;&gt;</a></li>";
                                        }else{
                                             echo "<li><a href='".HTTP_ROOT."projects/gridview?page=".$pagenext."' class=\"button_act\" >".__('Next')."&nbsp;&gt;</a></li>";
                                        }                                             
								//echo "<li><a href='".HTTP_ROOT."projects/gridview?page=".$pagenext."' class=\"button_act\" >Next&nbsp;&gt;</a></li>";
							}else{
                                        if($projtype == 'disabled'){
                                             echo "<li><a href='".HTTP_ROOT."projects/gridview/disabled?page=".$pagenext."' class=\"button_prev\">".__('Next')."&nbsp;&gt;</a></li>";
                                        }else{
                                             echo "<li><a href='".HTTP_ROOT."projects/gridview?page=".$pagenext."' class=\"button_prev\">".__('Next')."&nbsp;&gt;</a></li>";
                                        }
							...
							if($data2){
								echo "<li class='hellip'>&hellip;</li>";
                                        if($projtype == 'disabled'){
                                             echo "<li><a href='".HTTP_ROOT."projects/gridview/disabled?page=".floor($lastPage)."' class=\"button_act\" >".__('Last')." &raquo;</a></li>";
                                        }else{
                                             echo "<li><a href='".HTTP_ROOT."projects/gridview?page=".floor($lastPage)."' class=\"button_act\" >".__('Last')." &raquo;</a></li>";
                                        }
	...
	<tr>
		<td style="padding-left:10px;" valign="middle" class="ms_hd">
			...
			<div style="float:right;padding-right:13px;">
				<button class="green" id="inviteusr" onclick="newUser('menuid','loaderid','add_user');" style="margin-top:1px;height: 27px;width: 107px;padding:4px 12px;text-align: right;"><div class="icon_invt"></div><?php echo __('Invite User');?></button>
	...
	<tr>
		<td style="padding:5px 11px;" align="right">
			<span id="usersrch" style="display:none;">
				...
				<?php echo $this->Form->text('name',array('size'=>'35','class'=>'text_field','style'=>'padding:4px 26px 4px 5px;width: 190px;','id'=>'name','maxlength'=>'100','onkeyup'=>'searchuserkey()','placeholder'=>__('Enter User Name',true))); ?>
		...
		<td align="center">
			...
			<td valign="middle" style="width:500px" align="center" class="nwa">
				<span id="confirmbtn" style="display:block;">
					<button class="pop_btn" id="confirmusercls" style="margin-left:3px;" value="Confirm" type="button" onclick="assignuser(this)"><?php echo __('Add');?></button>
					Or <button class="pop_btn" id="confirmuserbut" style="margin-left:3px;" value="Confirm" type="button" onclick="assignuser(this)"><?php echo __('Add & Continue');?></button>
...
function removeuser(count,userid,pjid,uname) {
	...
	var conf = confirm("<?php echo __('Are you sure you want to remove');?> ' "+uname+"'?");
	if(conf == true) {
		var userDiv = 'userDiv'+count;
		var userImg = 'userImg'+count;
