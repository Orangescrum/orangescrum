<div class="fl_content">
	...
	<div class="imp_mgtl">
		<ul id="breadcrumbs_imp">
			<li <?php if(isset($upload_file)){ echo 'class="activ"';}?> ><?php echo __('Upload File');?></li>
			<li <?php if(isset($preview_data)){ echo 'class="activ"';}?> ><?php echo __('Preview Data');?></li>
			<li <?php if(isset($import_summery)){ echo 'class="activ"';}?>><?php echo __('Upload Summary');?></li>
		</ul>
		<div id="upload_file" <?php if(isset($fileds)){ echo "style='display:none;'";}?> >
			...
			<div class="chk_content">
				...
				<ul class="chk_desc">
					<li><?php echo __('What format is your list? We can import');?> <b><?php echo __('CSV');?></b> <?php echo __('files');?>  </li>
					<li>
						<a href="<?php echo HTTP_ROOT;?>projects/download_sample_csvfile"><?php echo __('Download a sample file');?></a> <?php echo __('to see what we can import');?> (
						<a href="<?php echo HTTP_ROOT;?>projects/learnmore" target="_blank" onclick="window.open(this.href, this.target, 'width=400,height=450,resizable,scrollbars');return false;"><?php echo __('Learn more');?></a>)		</li>
				</ul>
			</div>
			<div class="cb"></div>
			<div class="form_file">
				<h4 class="chk_head"><?php echo __('Upload your file');?></h4>
				<hr/>
		...
		<div id="review_data" <?php if(!isset($fileds)){ ?>style="display: none;"<?php }?>>
			...
			<table id="preview_data_tbl" border="1" width="100%">
				<tr>
					<th style="text-align:left" class="imp_tl"><?php echo __('Title');?></th>
					<th style="text-align:left" class="imp_ds"><?php echo __('Description');?></th>
					<th style="text-align:left" class="imp_dd"><?php echo __('Due Date');?></th>
					<th style="text-align:left" class="imp_st"><?php echo __('Status');?></th>
					<th style="text-align:left" class="imp_tp"><?php echo __('Type');?></th>
					<th style="text-align:left" class="imp_as"><?php echo __('Assigned to');?></th>
				</tr>
				<tr>
					<td colspan="6">
						...
						<table width="100%" style="text-align:left" >
							<tbody>
							<tr>
								<td colspan="6" class="tophead" style="border:1px solid #ddd"><?php echo '<b><i>'.$val['title'].'</i></b>';?> &nbsp;&nbsp; <span class="fr" style="margin-right: 2px;font-style:italic"><?php if($val['start_date']){?> <b><?php echo __('Start Date');?>: </b><?php echo date('m/d/Y',strtotime($val['start_date']));  }?>&nbsp;&nbsp; <?php if($val['end_date']){?> <b><?php echo __('End Date');?>: </b><?php echo date('m/d/Y',strtotime($val['end_date'])); }?></span></td>
							</tr>
							<?php
							if(isset($task) && $task){
					...
					<tr>
						<td style="" colspan="6">
							<ul class="chk_desc red_fnt">
								<li><?php echo __('Field values marked as red contain error data ,Those data will be assigned default value');?>.</li>
								<li><?php echo __('Due date will be Current date');?></li>
								<li><?php echo __('Status will be New');?></li>
								<li><?php echo __('Type will be Development');?></li>
								<li><?php echo __('Assigned to will be Me');?></li>
							</ul>
						</td>
					</tr>	
					<?php }?>
				...
				<tr>
					<td colspan="6" align="center">
						<button type="submit" class="pop_btn" style="width:97px"><?php echo __('Confirm');?></button>
					</td>
				</tr>
				<?php }?>
			</table>
