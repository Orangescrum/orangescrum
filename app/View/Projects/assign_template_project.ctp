			...
			<table cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td align="left" style="font-weight:bold;font-size:14px;">
						<div style="float:left;margin-top:5px;"><?php echo __('Template');?>:&nbsp;&nbsp;</div>
						...
						<div style="float:left;margin-top:5px;padding-left:25px"><?php echo __('Project');?>:&nbsp;&nbsp;</div>
						<div style="float:left;margin-top:5px;" >
						...
						<div style="float:left;font-size:10px;margin-left:10px;font-size:13px;">
							<span id="subprof1">
								<button style="margin: 5px 0 0;width:121px;text-align:right" value="Show Tasks" onclick="add_cases_project()"><div class="icon_fil"></div><?php echo __('Import Tasks');?></button>&nbsp;&nbsp;or&nbsp;&nbsp;<a href="<?php echo $referer; ?>" style="text-decoration:none;font-size:13px;font-weight:normal;"><?php echo __('Cancel');?></a>
							</span>
						</div>
		...
		<td style="padding-top:10px">
			<div id="show_temp_cases">
				...
				<tr height="28px" class="tophead">
						...
						<td  style="padding-left:4px;" align="left" width="80px"><?php echo __('Created On');?></td>
					...
					<tr class="<?php echo $clas?>" height="22px" id="mslisting<?php echo $count; ?>">
						...
						<td  align="center">
							<div style="width:75px;text-align:center;">
								<a href='<?php echo HTTP_ROOT; ?>projects/add_template/<?php echo $template['ProjectTemplate']['id']; ?>' class="makeHover"><div class="act_set" style="margin-left:5px;" rel=tooltip  title="<?php echo __('setting');?>"></div></a>
					...
					<tr>
						...
						<?php 
							...
							?>
						<td colspan="7" align="center">
							<div style="margin:10px;width:100%;text-align:center"><?php echo __('Select a template to view tasks');?></div>
					</td>
					<?php
						}
					?>
