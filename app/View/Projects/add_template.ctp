...
$(document).ready(function(){
    ...
    var appendRow = '<tr class="appendtotr"><td style="padding-left:7px;">' + clonedRow + '</td><td><div align="center" width="226px" id="btnRemove" valign="top"><a style="color:red;" href="#"><?php echo __('Remove');?></a></div></td></tr>';  
...
function add_more_temp(){
   ...
   var appendRow = '<tr class="appendtotr"><td style="padding-left:5px;">' + clonedRow + '</td><td><div align="center" width="226px" id="btnRemove" valign="top"><a style="color:red;" href="#"><?php echo __('Remove');?></a></div></td></tr>';
	$('.appendtotr:last').after(appendRow);
}
</script>
<div class="row-fluid">
			...
			<section class="tab-content">
				<div class="tab-pane" id="horizontal">
					...
					<table style="width:100%;margin-top:-40px" align="center">
						<tr align="right">
							<td colspan="2" align="right" style="padding-right:20px;"><?php echo __('Fields marked');?> <font color="red">*</font> <?php echo __('are mandatory Fields');?></td>
					   </tr>
						<tr>
							<td valign="top">
								...
								<table  align="left" class="add_temp_tbl add_temp_prj_ie">
									...
									{ ?>
										...
										<option value="">...<?php echo __('New Template');?></option>
									<?php
									}
									else
									{
								...
								<td></td>
												...
												<table>
													<tr>
														<td>
															<div class="fl case_fieldprof cs_prj_tmpl">
																<font color="red">* </font><?php echo __('Task Title');?>:
															</div>
															<div class="fl">
													...
													<tr height="40px" valign="top">
														...
														<td align="left" style="color:#000000;">
															<div class="fl case_fieldprof"><?php echo __('Task Description');?>:</div>
															<div class="fl">				
									...
									<td><div onclick="add_more_temp();"><a style="color:#5895B4; cursor:pointer"  ><?php echo __('Add new Row');?></a></div></td>
									</tr>
									<tr height="40px">
										<td align="left" style="padding-left:143px">
										<span id="subprof1">
										<button  value="Save" name="submit_template" id="submit_template" class="pop_btn"><?php echo __('Save');?></button>
...
<table cellspacing="0" cellpadding="0" width="700px" class="div_pop" align="center" style="margin:40px auto;">
	<tr class="ms_hd">
		<td style="padding-left:10px;" valign="middle">
			<div style="float:left"><h1 style="margin:0;padding:0;" class="popup_head"><?php echo __('New Template');?></font></h1></div>
			<div style="float:right;padding-right:5px;"><img src="<?php echo HTTP_IMAGES;?>images/popup_close.png" alt="Close" title="<?php echo __('Close');?>" onClick="cover_close('cover','add_temp_mod');unsel_temp();" style="cursor:pointer" /></div>
		</td>
	</tr>
	  <tr>
						  ...
						  <table cellpadding="4" cellspacing="4" border="0" align="center">
							...
							<tr>
								...
								<td align="left" style="padding-top:5px;">
								  ...
								  <span id="btn">
									  <button type="button" value="Create Template" name="crtTempmod" style="margin-left:3px;" id="add_new_template" class="pop_btn" onclick="template_module_add()"><?php echo __('Create');?></button>&nbsp;&nbsp;<?php echo __('or');?>&nbsp;&nbsp;<a href="javascript:void(0);" onClick="cover_close('cover','add_temp_mod');unsel_temp();"><?php echo __('Cancel');?></a>
								  </span>
							  </td>
							  </tr>
						  </table>
