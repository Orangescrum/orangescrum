...
<table cellspacing="0" cellpadding="0" width="355px" class="div_pop" align="center" style="top:12px;width:200px">
	  ...
	  <tr class="ms_hd">
		<td style="padding-left:10px; border-bottom: 1px solid #CCCCCC;" valign="middle">
			<div style="float:left"><h1 style="margin:0;padding:0;text-shadow:0px 0px 0px #fff; font-weight:normal" class="popup_head"><?php echo __('Save Custom Filter');?></font></h1></div>
			
			<div style="" class="ms_cls"><img src="<?php echo HTTP_IMAGES;?>images/popup_close.png" alt="Close" title="<?php echo __('Close');?>" onClick="cover_close('cover','inner_save_filter');" style="cursor:pointer"/></div>
		</td>
	</tr>
	  <tr>
						  ...
						  <table cellpadding="10" cellspacing="10" border="0" align="center">
							  ...
							  <tr>
								  <td align="right" class="case_fieldprof" valign="top" style="width:150px; font-weight:normal; padding:3px 0px">
									  <?php echo __('Filter');?>&nbsp;<?php echo __('Name');?>:
								  </td>
								  <td align="left">
                                     ...
                                     <tr style="display:none" id="err_msg"><td></td><td style="color:red;"><?php echo __('Name cannot be left blank');?>!</td></tr>
							  ...
							  <tr>
								  ...
								  <td align="left">
									  ...
									  <span id="btn">
										  <button type="submit" value="Create" name="crtProject" class="blue" onclick="submitfilter();"><?php echo __('Confirm');?></button>&nbsp;&nbsp;or&nbsp;&nbsp;<a href="javascript:void(0);" onClick="cover_close('cover','inner_save_filter');"><?php echo __('Cancel');?></a>
									  </span>
