...
function caseSetting(proj,mem)
{
	...
	{
		var msg="<?php echo __('Please selct a Project to Assign Member(s)');?>!";
												...
												<table cellpadding="0" cellspacing="0" border="0">
													<tr height="20px">
														<td align="center" class="label-normal" style="font-weight:bold;">
															<?php echo __('Member(s) Available');?> - <?php echo count($memsAvlArr); ?>
														</td>
													</tr>
													<tr height="30px">
														<td align="center" class="text">
															Select:
															<a href='#' onclick='return $.dds.selectAll("list_1");' class="footerLnk" style="text-decoration:underline"><?php echo __('All');?></a>&nbsp;
															<a href='#' onclick='return $.dds.selectNone("list_1");' class="footerLnk" style="text-decoration:underline"><?php echo __('None');?></a> 
														</td>
													</tr>
																		...
																		<?php echo $this->Format->formatText($getMemsAvl['User']['name'])?>
																		 <?php 
																		  ...
																		  if($getMemsAvl['CompanyUser']['user_type'] == 1){ 
																			$colors= 'color:Green';$usr_typ_name=__('Owner',true);
																		  }else if($getMemsAvl['CompanyUser']['user_type'] == 2){
																				$colors= 'color:Red';$usr_typ_name=__('Admin',true);
												...
												<table cellpadding="0" cellspacing="0" border="0">
													...
													<tr height="20px">
														<td align="center" class="label-normal" >
															<font style="color:#575A5D;font-weight:bold"><?php echo __('Member(s) Assigned');?> - <?php echo count($memsExtArr); ?></font>	
														</td>
													</tr>
													<tr height="30px">
														<td align="center" class="text">
															Select: 
															<a href='#' onclick='return $.dds.selectAll("list_2");' class="footerLnk" style="text-decoration:underline"><?php echo __('All');?></a> 
															<a href='#' onclick='return $.dds.selectNone("list_2");' class="footerLnk" style="text-decoration:underline"><?php echo __('None');?></a> 
														</td>
													</tr>
													<tr>
													...
													<tr>
														<td align="center" style="padding-top:45px">
															<font color="#FF0000" style="font:bold 12px verdana;"><?php echo __('Select a Project to Assign Member(s)');?></font>
							...
							<tr>
								<td class="label-normal" align="center">
									<div style="position:relative;top:-8px;">
										...
										<button type="submit" value="Save" name="submit_Project" style="margin-left:3px;margin-top:5px;width:60px" class="blue small"><?php echo __('Save');?></button>
										or
