...
<div class="close_oly">
    <div class="close_txt">
        <div class="fl oly_wc"><?php echo __('Welcome to');?> <img src="img/images/logo_outer_sml.png" style="margin-top: -4px; margin-left: 4px;" /> !</div>
        <div class="oly_text fr">
            <div><?php echo __('Take a moment to note the main action links');?>.</div>
	    <button class="btn btn_blue" type="button" onClick="close_test();"><?php echo __('Ok, I got it');?>.</button>
	</div>
        <div class="cb"></div>
    </div>
</div>
<div class="main_overlay">
    ...
    <div class="oly_usr_sett">
        ...
        <div class="oly_usr_sett_txt"><?php echo __('Personal, Company & Account Settings');?></div>
    </div>
    <div class="oly_lcnt_mdiv">
        <div class="oly_container oly_cont_mt1">
            <div class="fl oly_cont_fbdr"></div>
            <div class="fl oly_cont_txt"><?php echo __('ToDos, Summary and Statistics');?></div>
            <div class="cb"></div>
        </div>
        <div class="oly_container oly_cont_mt2">
            <div class="fl oly_cont_fbdr"></div>
            <div class="fl oly_cont_txt"><?php echo __('Search, Filter, Order and Group Tasks');?></div>
            <div class="cb"></div>
        </div>
        <div class="oly_container oly_cont_mt3">
            <div class="fl oly_cont_fbdr"></div>
            <div class="fl oly_cont_txt"><?php echo __('List of files attached to the tasks');?></div>
            <div class="cb"></div>
        </div>
        <div class="oly_container oly_cont_mt4">
            <div class="fl oly_cont_fbdr"></div>
            <div class="fl oly_cont_txt"><?php echo __('Create Task Group, set a due date and add task to the Task Groups');?></div>
            <div class="cb"></div>
        </div>
        <div class="oly_container oly_cont_mt5">
            <div class="fl oly_cont_fbdr"></div>
            <div class="fl oly_cont_txt"><?php echo __('Create and manage Projects. Assign projects to Team');?></div>
            <div class="cb"></div>
        </div>
        <div class="oly_container oly_cont_mt6">
            <div class="fl oly_cont_fbdr"></div>
            <div class="fl oly_cont_txt"><?php echo __('Add and manage Team members. Add users to projects');?>.</div>
            <div class="cb"></div>
        </div>
        <div class="oly_container oly_cont_mt7">
            <div class="fl oly_cont_fbdr"></div>
            <div class="fl oly_cont_txt"><?php echo __('Just schedule it and get Daily Progress Update from your');?></div>
            <div class="cb"></div>
        </div>
    </div>
</div>
<script type="text/javascript">
    function close_test(){
        $.ajax('/projects/hide_default_inner',{},function(res){
        });
        $('.main_overlay').hide();
