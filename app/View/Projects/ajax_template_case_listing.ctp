...
<table border="0" style="border:1px solid #CFD7DD;" width="100%" align="center" cellspacing="0" cellpadding="0">
	<tr bgcolor="#E5E5E5" valign="center" style="font-weight:bold;color:#333333;">
		...
		<td style="padding-left:10px;"><?php echo __('Sl');?>#</td>
		<td style="padding-left:10px;"><?php echo __('Title');?></td>
		<td style="padding-left:10px;"><?php echo __('Description');?></td>
		<td style="padding-left:10px;"><?php echo __('Created By');?></td>
		<td style="padding-left:10px;"><?php echo __('Created On');?></td>
	</tr>
	<?php
...
<?php
	...
	?>
	<center style="font-weight:normal;color:#FF0000;padding:10px;"><?php echo __('No Tasks for this Template');?></center>
	<?php
}
