                                ...
                                <table bgcolor="#FFF" border="0" cellspacing="0" cellpadding="20" width="100%">
                                    <tr>
                                        <td width="100%" bgcolor="#FFF" style="text-align:left;">
                                            ...
                                            <p>Below are the information of the disabled company.</p>
                                            <p>
                                                Company Id: <?php echo $comp_nm; ?><br />
                                                Owner name & email: <?php echo $user_nm . '(' . $email_nm . ')'; ?><br />
                                                Customer id: <?php echo ($custo_nm) ? $custo_nm : NA; ?><br />
                                                Plan: <?php echo $plan_nm; ?><br />
                                                <?php
