                                ...
                                <table bgcolor="#FFF" border="0" cellspacing="0" cellpadding="20" width="100%">
                                    <tr>
                                        <td width="100%" bgcolor="#FFF" style="text-align:left;">
                                            ...
                                            <p><?php echo __("You have been assigned as");?><?php echo " ";?><b><?php echo __("Owner");?><?php echo " ";?></b><?php echo __("of below company.");?></p>
                                            <p>
                                                <?php echo __("Company :");?> <?php echo $company_name; ?><br />
                                                <?php echo __("Owner name & email:");?> <?php echo $name . '(' . $email . ')'; ?><br />
                                            </p>								
