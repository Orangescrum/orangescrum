                   ...
                   <table bgcolor="#FFF" border="0" cellspacing="0" cellpadding="20" width="100%">
                        <tr>
                            <td width="100%" bgcolor="#FFF" style="text-align:left;">
								...
								<p><?php echo ucfirst($from_name); ?>  <?php echo __("added you to project");?> <b><?php echo $projName;?></b> <?php echo __("on");?> <?php echo ucfirst($company_name)?>.</p>
								
								<p><?php echo __("Click on the below button to read the original message, view comments, reply & download attachments.");?></p>
								<?php if(!$multiple) { 
									$button =   __("Go to Project");
								}else {
									$button =  __("Go to Projects");
								} ?>
