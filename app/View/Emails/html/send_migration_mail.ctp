                                ...
                                <table bgcolor="#FFF" border="0" cellspacing="0" cellpadding="20" width="100%">
                                    <tr>
                                        <td width="100%" bgcolor="#FFF" style="text-align:left;">
                                            ...
                                            <p>All data(projects, tasks, users etc..) has been migrated successfully from company  <b><?php echo $from_com;?></b> to company <b><?php echo $to_com;?></b>. <br />Please have a look.</p>
                                               <p>
                                            <table cellpadding='1' cellspacing='1' align='left' width='100%'>
                                                <tr height='20px'><td>&nbsp;</td></tr>
                                                <?php echo EMAIL_FOOTER;?></table>
                                            </p>
                                        </td>
                                    </tr>
                                </table>
