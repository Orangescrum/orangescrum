...
<td style="text-align:left;padding-top:0px"><a target="_blank" style="font:bold 22px verdana;color:#e85d12" href="https://www.orangescrum.com/"><img border="0" alt="Orangescrum" title="Orangescrum" src="https://app.orangescrum.com/img/images/logo_outer.png">
...
Configure::write('invite_user_footer',"<table cellpadding='0' cellspacing='0' align='left' width='100%'><tr><td align='left' style='font-size:14px;padding-top:5px;color:#737373' colspan='2'>If you have any questions, please write to support email, we will be happy to help you.</td></tr></table>");
